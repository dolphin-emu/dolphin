#include "DolphinDefinedAPIs.h"
 ...
 Dolphin_Defined_ScriptContext_APIs scriptContext_APIs;
...
{
  scriptContext_APIs = *new_dolphinDefinedScriptContext_APIs;
}
...
DLL_Export unsigned long long GetTestValue(unsigned long long input)
{
  if (input == 400)
    return 69;
  else
