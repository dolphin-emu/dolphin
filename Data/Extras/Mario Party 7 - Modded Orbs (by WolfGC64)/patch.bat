...
if "%PATCHER%"=="RVZ" (
    cls
    "tools/dolphintool" convert -i "tmp/game.iso" -o "Mario Party 7 (USA) [Modded Orbs] (%VERSION%).rvz" -f "rvz" -b "131072" -c "zstd" -l "5"
    del "tmp\game.iso"
    cls
    echo = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
    echo Success! Your game is located in "Mario Party 7 (USA) [Modded Orbs] (%VERSION%).rvz" 
    echo = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
)

if "%PATCHER%"=="ISO" (
    cls
    move "tmp\game.iso" "Mario Party 7 (USA) [Modded Orbs] (%VERSION%).iso"
    cls
    echo = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
    echo Success! Your game is located in "Mario Party 7 (USA) [Modded Orbs] (%VERSION%).iso" 
    echo = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
)
