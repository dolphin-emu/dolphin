...
Dolphin can only be installed on devices that satisfy the above requirements. Any attempt to install Dolphin on an unsupported device will result in a failed installation. An error message will display afterwards.
