...
Dolphin can only be installed on devices that satisfy the above requirements. Attempting to install Dolphin on an unsupported device will result in a failed download. Dolphin will display an error message after.
