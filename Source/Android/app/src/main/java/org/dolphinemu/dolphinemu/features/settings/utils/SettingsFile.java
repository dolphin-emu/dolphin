...
public final class SettingsFile
{
  ...
  private static File getWiiProfile(String profile, String padId)
  {
    String wiiConfigPath =
            DirectoryInitializationService.getUserDirectory() + "/Config/Profiles/Wiimote/" +
                    profile + ".ini";
    ...
    if (!wiiProfile.exists())
    {
      String defautlWiiProfilePath =
              DirectoryInitializationService.getUserDirectory() +
                      "/Config/Profiles/Wiimote/WiimoteProfile.ini";
      DirectoryInitializationService.copyFile(defautlWiiProfilePath, wiiConfigPath);
