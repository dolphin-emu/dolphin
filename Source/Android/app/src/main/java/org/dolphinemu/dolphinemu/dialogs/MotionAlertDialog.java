...
public final class MotionAlertDialog extends AlertDialog
{
	 ...
	 * @param item    The Preference to show this dialog for.
	 */
	public MotionAlertDialog(Context context, InputBindingSetting item)
	{
		super(context);
	...
	private void saveInput(InputDevice device, KeyEvent keyEvent, InputDevice.MotionRange motionRange, boolean axisPositive)
	{
		...
		if (uiString != null)
		{
			...
			editor.putString(item.getKey(), uiString);
			editor.apply();
		}
		else
		{
