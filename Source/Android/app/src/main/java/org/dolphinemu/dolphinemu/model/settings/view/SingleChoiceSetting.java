...
public final class SingleChoiceSetting extends SettingsItem
{
	...
	public SingleChoiceSetting(String key, String section, String file, int titleId, int descriptionId, int choicesId, int valuesId, int defaultValue, Setting setting)
	{
