...
public enum BooleanSetting implements AbstractBooleanSetting
{
  ...
  //guitar
  MAIN_BUTTON_TOGGLE_GUITAR_0(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGuitarButtonMinus", true),
  MAIN_BUTTON_TOGGLE_GUITAR_1(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGuitarButtonPlus", true),
  MAIN_BUTTON_TOGGLE_GUITAR_2(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGuitarButtonGreen", true),
  MAIN_BUTTON_TOGGLE_GUITAR_3(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGuitarButtonRed", true),
  MAIN_BUTTON_TOGGLE_GUITAR_4(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGuitarButtonBlue", true),
  MAIN_BUTTON_TOGGLE_GUITAR_5(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGuitarButtonYellow", true),
  MAIN_BUTTON_TOGGLE_GUITAR_6(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGuitarButtonOrange", true),
  MAIN_BUTTON_TOGGLE_GUITAR_7(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGuitarStrumUp", true),
  MAIN_BUTTON_TOGGLE_GUITAR_8(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGuitarStrumDown", true),
  MAIN_BUTTON_TOGGLE_GUITAR_9(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGuitarStick", true),
  MAIN_BUTTON_TOGGLE_GUITAR_10(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleGuitarWhammy", true),
  //drum
  ...
  MAIN_BUTTON_TOGGLE_DRUM_1(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleDrumPlus", true),
  MAIN_BUTTON_TOGGLE_DRUM_2(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleDrumGreen", true),
  MAIN_BUTTON_TOGGLE_DRUM_3(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleDrumRed", true),
  MAIN_BUTTON_TOGGLE_DRUM_4(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleDrumBlue", true),
  MAIN_BUTTON_TOGGLE_DRUM_5(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleDrumYellow", true),
  MAIN_BUTTON_TOGGLE_DRUM_6(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleDrumOrange", true),
  MAIN_BUTTON_TOGGLE_DRUM_7(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleDrumBass1", true),
  MAIN_BUTTON_TOGGLE_DRUM_8(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleDrumBass2", false),
  MAIN_BUTTON_TOGGLE_DRUM_9(Settings.FILE_DOLPHIN, Settings.SECTION_INI_ANDROID_OVERLAY_BUTTONS,
          "ButtonToggleDrumStick", true),
