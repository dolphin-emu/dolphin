...
class Camera {
    companion object {
        ...
        private var cameraEntries = arrayOf("Disabled")
        private var cameraValues = arrayOf("")
        ...
        fun startCamera(width: Int, height: Int) {
            ...
            Log.i(TAG, "Selected Camera: " + StringSetting.MAIN_EMULATE_CAMERA.string)
            ...
            cameraProviderFuture.addListener({
                ...
                val cameraSelector = cameraProvider.getAvailableCameraInfos()
                    .get(Integer.parseInt(StringSetting.MAIN_EMULATE_CAMERA.string))
                    .cameraSelector
