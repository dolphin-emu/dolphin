...
public class FilePickerFragment extends AbstractFilePickerFragment<File>
{
   ...
   */
  public void showHiddenItems(boolean showHiddenItems) { this.showHiddenItems = showHiddenItems; }
  ...
  public boolean areHiddenItemsShown() { return showHiddenItems; }
  ...
  public Uri toUri(@NonNull final File file)
  {
    return FileProvider.getUriForFile(
        getContext(), getContext().getApplicationContext().getPackageName() + ".provider", file);
  }
  ...
  public Loader<SortedList<File>> getLoader()
  {
    return new AsyncTaskLoader<SortedList<File>>(getActivity()) {
      ...
      public SortedList<File> loadInBackground()
      {
        ...
        SortedList<File> files =
            new SortedList<>(File.class, new SortedListAdapterCallback<File>(getDummyAdapter()) {
              @Override
