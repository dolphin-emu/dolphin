...
Java_org_dolphinemu_dolphinemu_features_input_InputOverrider_registerGameCube(JNIEnv*, jclass,
                                                                              int controller_index)
{
  ciface::Touch::RegisterGameCubeInputOverrider(controller_index);
}

JNIEXPORT void JNICALL Java_org_dolphinemu_dolphinemu_features_input_InputOverrider_registerWii(
...
JNIEXPORT void JNICALL
Java_org_dolphinemu_dolphinemu_features_input_InputOverrider_unregisterGameCube(
    JNIEnv*, jclass, int controller_index)
{
  ciface::Touch::UnregisterGameCubeInputOverrider(controller_index);
}

JNIEXPORT void JNICALL Java_org_dolphinemu_dolphinemu_features_input_InputOverrider_unregisterWii(
    JNIEnv*, jclass, int controller_index)
{
  ciface::Touch::UnregisterWiiInputOverrider(controller_index);
}

JNIEXPORT void JNICALL Java_org_dolphinemu_dolphinemu_features_input_InputOverrider_setControlState(
...
JNIEXPORT void JNICALL
Java_org_dolphinemu_dolphinemu_features_input_InputOverrider_clearControlState(JNIEnv*, jclass,
                                                                               int controller_index,
                                                                               int control)
{
...
Java_org_dolphinemu_dolphinemu_features_input_InputOverrider_getGateRadiusAtAngle(
