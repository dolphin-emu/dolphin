...
JNIEXPORT void JNICALL Java_org_dolphinemu_dolphinemu_features_gba_GbaRenderer_setTvRightOffset(
    JNIEnv*, jclass, jint offset)
{
  if (g_presenter)
    g_presenter->SetTVRightOffset(offset);
}

JNIEXPORT void JNICALL
Java_org_dolphinemu_dolphinemu_features_gba_GbaRenderer_setTvTopOffset(JNIEnv*, jclass, jint offset)
{
  if (g_presenter)
    g_presenter->SetTVTopOffset(offset);
}

JNIEXPORT void JNICALL Java_org_dolphinemu_dolphinemu_features_gba_GbaRenderer_setTvBottomOffset(
    JNIEnv*, jclass, jint offset)
{
  if (g_presenter)
    g_presenter->SetTVBottomOffset(offset);
}
