...
u64 Timer::GetLocalTimeSinceJan1970()
{
  time_t sysTime;
  time(&sysTime);
  return LocalTimeDST(static_cast<u32>(sysTime));
}

u64 Timer::GetLocalTimeSinceJan1970(u32 epoch_time)
{
  return LocalTimeDST(epoch_time);
}
