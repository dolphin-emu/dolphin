...
public:
	...
	public:
		...
		typedef std::map<std::string, std::string, CaseInsensitiveStringCompare> SectionMap;

		const std::string& GetName() { return name; }
		const SectionMap& GetValues() { return values; }
	...
	const std::list<Section>& GetSections() { return sections; }
