 ...
 *
 * For BitField<X,Y,Z>, X is the offset of the bitfield within the raw value,
 * Y is the length in bits of the bitfield. Z is an integer type which
 * determines the sign of the bitfield. Z must have the same size as the
 * raw integer.
 *
 *
 * General usage:
