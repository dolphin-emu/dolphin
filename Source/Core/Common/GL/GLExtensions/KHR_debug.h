...
typedef void(APIENTRYP PFNDOLDEBUGMESSAGECALLBACKPROC)(
    GLDEBUGPROC callback, const GLvoid* userParam);
typedef void(APIENTRYP PFNDOLDEBUGMESSAGECONTROLPROC)(GLenum source, GLenum type, GLenum severity,
    GLsizei count, const GLuint* ids, GLboolean enabled);
typedef void(APIENTRYP PFNDOLDEBUGMESSAGEINSERTPROC)(
...
typedef GLuint(APIENTRYP PFNDOLGETDEBUGMESSAGELOGPROC)(GLuint count, GLsizei bufsize,
    ...
    GLchar* messageLog);
typedef void(APIENTRYP PFNDOLGETOBJECTLABELPROC)(
    GLenum identifier, GLuint name, GLsizei bufSize, GLsizei* length, GLchar* label);
typedef void(APIENTRYP PFNDOLGETOBJECTPTRLABELPROC)(
    void* ptr, GLsizei bufSize, GLsizei* length, GLchar* label);
typedef void(APIENTRYP PFNDOLOBJECTLABELPROC)(
...
typedef void(APIENTRYP PFNDOLPUSHDEBUGGROUPPROC)(
