                                  ...
                                  HDC* pbuffer_dc)
{
  ...
  if (!wglChoosePixelFormatARB(onscreen_dc, pf_iattribs.data(), pf_fattribs.data(),
                               ARRAYSIZE(compatible_formats), compatible_formats,
                               &num_compatible_formats))
  {
  ...
  HPBUFFERARB pbuffer =
      wglCreatePbufferARB(onscreen_dc, compatible_formats[0], width, height, pb_attribs.data());
  if (!pbuffer)
  {
