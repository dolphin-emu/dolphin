...
template <typename T>
static inline constexpr int CountSetBits(T v)
{
...
#else
static inline constexpr int CountSetBits(u8 val) { return __builtin_popcount(val); }
static inline constexpr int CountSetBits(u16 val) { return __builtin_popcount(val); }
static inline constexpr int CountSetBits(u32 val) { return __builtin_popcount(val); }
static inline constexpr int CountSetBits(u64 val) { return __builtin_popcountll(val); }
