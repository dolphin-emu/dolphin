...
public:
  ...
  LogTypes::LOG_LEVELS GetLogLevel(LogTypes::LOG_TYPE type) const;
...
private:
  struct LogState
  {
    LogTypes::LOG_LEVELS log_level = LogTypes::LSUPPRESS;
  ...
  std::array<LogState, LogTypes::NUMBER_OF_LOGS> m_log{};
