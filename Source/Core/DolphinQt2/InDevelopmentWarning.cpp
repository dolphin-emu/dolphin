    ...
    : QDialog(parent, Qt::WindowSystemMenuHint | Qt::WindowTitleHint | Qt::WindowCloseButtonHint)
{
  ...
  logo->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Minimum);
  ...
  content_layout->addLayout(body_column);
...
QBrush InDevelopmentWarning::MakeConstructionBrush()
{
...
bool InDevelopmentWarning::LaunchDolphinWX()
{
  QFileInfo file_info;
