...
void Resources::Init() {
  QString sys_dir =
      QString::fromStdString(File::GetSysDirectory() + RESOURCES_DIR + DIR_SEP);

  QStringList platforms{QStringLiteral("Platform_Gamecube.png"),
  ...
  QStringList countries{QStringLiteral("Flag_Europe.png"),
  ...
  QStringList ratings{
      QStringLiteral("rating0.png"), QStringLiteral("rating1.png"),
...
QPixmap Resources::GetPlatform(int platform) { return m_platforms[platform]; }

QPixmap Resources::GetCountry(int country) { return m_countries[country]; }

QPixmap Resources::GetRating(int rating) { return m_ratings[rating]; }

QPixmap Resources::GetMisc(int id) { return m_misc[id]; }
