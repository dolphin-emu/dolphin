...
static bool LoadOculusDLL()
{
	...
	b = b && (ovrHmd_ConfigureTracking = (PFUNC_HMD_INT_INT)GetProcAddress(dll, "ovrHmd_ConfigureTracking"));
	...
	b = b && (ovrHmd_BeginFrameTiming = (PFUNC_FRAMETIMING)GetProcAddress(dll, "ovrHmd_BeginFrameTiming"));
	b = b && (ovrHmd_GetFrameTiming = (PFUNC_FRAMETIMING)GetProcAddress(dll, "ovrHmd_GetFrameTiming"));
	...
	b = b && (ovrHmd_DismissHSWDisplay = (PFUNC_CHAR_HMD)GetProcAddress(dll, "ovrHmd_DismissHSWDisplay"));
