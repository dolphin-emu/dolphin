...
public:
  static std::unique_ptr<VertexLoaderBase>
  CreateVertexLoader(const TVtxDesc &vtx_desc, const VAT &vtx_attr);
...
protected:
  ...
  TVtxDesc m_VtxDesc; // Not really used currently - or well it is, but could be
                      // easily avoided.
  VAT m_vat;
};
