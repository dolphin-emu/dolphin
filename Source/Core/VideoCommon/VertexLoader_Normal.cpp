...
template <Common::UnsignedIntegral I, typename T, u32 N, u32 Offset>
...
template <Common::UnsignedIntegral I, typename T, u32 N>
void Normal_ReadIndex(VertexLoader* loader)
{
  Normal_ReadIndex_Offset<I, T, N, 0>(loader);
}

template <Common::UnsignedIntegral I, typename T>
