...
static BugInfo m_known_bugs[] = {
    ...
    {API_VULKAN, OS_ALL, VENDOR_ATI, DRIVER_ATI, Family::UNKNOWN,
     BUG_BROKENFRAGMENTSHADERINDEXDECORATION, -1.0, -1.0, true},
    {API_OPENGL, OS_WINDOWS, VENDOR_ATI, DRIVER_ALL, Family::UNKNOWN, BUG_BROKENDUALSOURCEBLENDING,
     -1.0, -1.0, true},
    {API_OPENGL, OS_OSX, VENDOR_INTEL, DRIVER_ALL, Family::UNKNOWN, BUG_BROKENDUALSOURCEBLENDING,
     -1.0, -1.0, true},
};
