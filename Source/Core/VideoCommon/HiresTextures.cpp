...
void HiresTexture::Update()
{
  ...
  std::set<std::string> sys_tex_dirs = GetTextureDirectoriesWithGameId(
      File::GetSysDirectory() + LOAD_DIR DIR_SEP HIRES_TEXTURES_DIR DIR_SEP, game_id);
  texture_directories.merge(sys_tex_dirs);
