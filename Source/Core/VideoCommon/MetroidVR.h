...
typedef enum {
  ...
  METROID_INVENTORY_SAMUS_OUTLINE,
  METROID_MAP_NORTH,
  METROID_SCAN_VISOR,
  METROID_SCAN_TEXT,
...
extern bool g_metroid_scan_visor, g_metroid_scan_visor_active, g_metroid_xray_visor,
    g_metroid_thermal_visor, g_metroid_map_screen, g_metroid_inventory, g_metroid_dark_visor,
    g_metroid_echo_visor, g_metroid_morphball_active;
