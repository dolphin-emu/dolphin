...
ShaderCode GenerateVertexShaderCode(API_TYPE api_type,
  ...
  GenerateVSOutputMembers(out, api_type, uid_data->numTexGens,
    ...
    if (g_ActiveConfig.backend_info.bSupportsGeometryShaders) {
      ...
      GenerateVSOutputMembers(out, api_type, uid_data->numTexGens,
                              ...
                              GetInterpolationQualifier(
                                  uid_data->msaa, uid_data->ssaa, false, true));
      out.Write("} vs;\n");
    } else {
  ...
  GenerateLightingShaderCode(out, uid_data->lighting, uid_data->components,
                             "color", "o.colors_");
  ...
  for (unsigned int i = 0; i < uid_data->numTexGens; ++i) {
    ...
    if (uid_data->dualTexTrans_enabled &&
      ...
      out.Write("o.tex[%d].xyz = float3(dot(P0.xyz, o.tex[%d].xyz) + P0.w, "
                "dot(P1.xyz, "
                "o.tex[%d].xyz) + P1.w, dot(P2.xyz, o.tex[%d].xyz) + P2.w);\n",
                i, i, i, i);
    }
