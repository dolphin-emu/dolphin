...
#define SUMEM_GENMODE          0x00
#define SUMEM_DISPLAYCOPYFILER 0x01 // 0x01 + 4
#define SUMEM_IND_MTXA         0x06 // 0x06 + (3 * 3)
#define SUMEM_IND_MTXB         0x07 // 0x07 + (3 * 3)
#define SUMEM_IND_MTXC         0x08 // 0x08 + (3 * 3)
#define SUMEM_IND_IMASK        0x0F
#define SUMEM_IND_CMD          0x10 // 0x10 + 16
#define SUMEM_SCISSORTL        0x20
#define SUMEM_SCISSORBR        0x21
#define SUMEM_LINEPTWIDTH      0x22
#define SUMEM_SU_COUNTER       0x23
#define SUMEM_RAS_COUNTER      0x24
#define SUMEM_RAS1_SS0         0x25 
#define SUMEM_RAS1_SS1         0x26
#define SUMEM_IREF             0x27
#define SUMEM_TREF             0x28 // 0x28 + 8
#define SUMEM_SU_SSIZE         0x30 // 0x30 + (2 * 8)
#define SUMEM_SU_TSIZE         0x31 // 0x31 + (2 * 8)
#define SUMEM_ZMODE            0x40
#define SUMEM_BLENDMODE        0x41
#define SUMEM_CONSTANTALPHA    0x42
#define SUMEM_ZCOMPARE         0x43
#define SUMEM_FIELDMASK        0x44
#define SUMEM_SETDRAWDONE      0x45
#define SUMEM_CLOCK0           0x46
#define SUMEM_PE_TOKEN_ID	   0x47
#define SUMEM_PE_TOKEN_INT_ID  0x48
#define SUMEM_EFB_TL           0x49
#define SUMEM_EFB_BR           0x4A
#define SUMEM_EFB_ADDR         0x4B
#define SUMEM_MIPMAP_STRIDE    0x4D
#define SUMEM_COPYYSCALE       0x4E
#define SUMEM_CLEAR_AR         0x4F
#define SUMEM_CLEAR_GB         0x50
#define SUMEM_CLEAR_Z          0x51
#define SUMEM_TRIGGER_EFB_COPY 0x52
#define SUMEM_COPYFILTER0      0x53
#define SUMEM_COPYFILTER1      0x54
#define SUMEM_CLEARBBOX1       0x55 
#define SUMEM_CLEARBBOX2       0x56
#define SUMEM_UNKNOWN          0x58
#define SUMEM_SCISSOROFFSET    0x59
#define SUMEM_UNKNOWN1         0x60
#define SUMEM_UNKNOWN2         0x61
#define SUMEM_UNKNOWN3         0x62
#define SUMEM_UNKNOWN4         0x63
#define SUMEM_LOADTLUT0        0x64
#define SUMEM_LOADTLUT1        0x65
#define SUMEM_TEXINVALIDATE    0x66
#define SUMEM_SETGPMETRIC      0x67
#define SUMEM_FIELDMODE        0x68
#define SUMEM_CLOCK1           0x69
#define SUMEM_TX_SETMODE0      0x80 // 0x80 + 4
#define SUMEM_TX_SETMODE1      0x84 // 0x84 + 4
#define SUMEM_TX_SETIMAGE0     0x88 // 0x88 + 4
#define SUMEM_TX_SETIMAGE1     0x8C // 0x8C + 4
#define SUMEM_TX_SETIMAGE2     0x90 // 0x90 + 4
#define SUMEM_TX_SETIMAGE3     0x94 // 0x94 + 4
#define SUMEM_TX_SETTLUT       0x98 // 0x98 + 4
#define SUMEM_TX_SETMODE0_4    0xA0 // 0xA0 + 4
#define SUMEM_TX_SETMODE1_4    0xA4 // 0xA4 + 4
#define SUMEM_TX_SETIMAGE0_4   0xA8 // 0xA8 + 4
#define SUMEM_TX_SETIMAGE1_4   0xAC // 0xA4 + 4
#define SUMEM_TX_SETIMAGE2_4   0xB0 // 0xB0 + 4
#define SUMEM_TX_SETIMAGE3_4   0xB4 // 0xB4 + 4
#define SUMEM_TX_SETLUT_4      0xB8 // 0xB8 + 4
#define SUMEM_TEV_COLOR_ENV    0xC0 // 0xC0 + (2 * 16)
#define SUMEM_TEV_ALPHA_ENV    0xC1 // 0xC1 + (2 * 16)
#define SUMEM_TEV_REGISTER_L   0xE0 // 0xE0 + (2 * 4)
#define SUMEM_TEV_REGISTER_H   0xE1 // 0xE1 + (2 * 4)
#define SUMEM_FOGRANGE         0xE8
#define SUMEM_FOGPARAM0        0xEE
#define SUMEM_FOGBMAGNITUDE    0xEF
#define SUMEM_FOGBEXPONENT     0xF0
#define SUMEM_FOGPARAM3        0xF1
#define SUMEM_FOGCOLOR         0xF2
#define SUMEM_ALPHACOMPARE     0xF3
#define SUMEM_BIAS			   0xF4
#define SUMEM_ZTEX2			   0xF5
#define SUMEM_TEV_KSEL         0xF6 // 0xF6 + 8
#define SUMEM_BP_MASK          0xFE
