...
static constexpr double FPS_SAMPLE_RC = 0.3;
static constexpr s64 FPS_SAMPLE_TIME_US = 500000;
...
void FPSCounter::Update()
{
  ...
  const double frames =
      m_dt_queue.size() - (m_dt_total - FPS_SAMPLE_TIME_US) / double(m_dt_queue.front());
