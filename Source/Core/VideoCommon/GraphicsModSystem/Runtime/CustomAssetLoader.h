...
public:
  ...
  std::shared_ptr<CustomTextureAsset> LoadTexture(const CustomAssetLibrary::AssetID& asset_id,
                                                  std::shared_ptr<CustomAssetLibrary> library);

  std::shared_ptr<CustomGameTextureAsset>
  LoadGameTexture(const CustomAssetLibrary::AssetID& asset_id,
                  std::shared_ptr<CustomAssetLibrary> library);
...
private:
  ...
  std::map<CustomAssetLibrary::AssetID, std::weak_ptr<CustomTextureAsset>> m_textures;
  std::map<CustomAssetLibrary::AssetID, std::weak_ptr<CustomGameTextureAsset>> m_game_textures;
