...
//  GXSetTevIndirect(tevstage+2, indstage, 0, 0, 0, 0, 0, 1, 0, 0)
	...
	union TevStageIndirect
	{
		...
		BitField<19, 1, u32> lb_utclod;  // Use modified or unmodified texture coordinates for LOD computation
		BitField<20, 1, u32> fb_addprev; // 1 if the texture coordinate results from the previous TEV stage should be added
