...
struct VideoConfig final
{
  VideoConfig() = default;
  void Refresh();
  void VerifyValidity(BackendInfo& backend_info);
  ...
  bool UseVSForLinePointExpand(const BackendInfo& backend_info) const;
  bool ExclusiveFullscreenEnabled(const BackendInfo& backend_info) const;
  bool UseGPUTextureDecoding(const BackendInfo& backend_info) const;
};
