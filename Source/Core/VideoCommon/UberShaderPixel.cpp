...
ShaderCode GenPixelShader(DSTALPHA_MODE dstAlphaMode, API_TYPE ApiType, bool per_pixel_depth, bool msaa, bool ssaa)
{
	...
	out.Write( // TODO: Skip preload on Nvidia and other GPUs which can't handle dynamic indexed arrays?
		...
		"\n"
		"			indtex[i] = sampleTexture(texmap, float2(fixedPoint_uv) * " I_TEXDIMS"[texmap].xy).abg;\n"
		"		}\n"
		"		else\n"
		"		{\n"
		"			indtex[i] = int3(0, 0, 0);\n"
	...
	out.Write(
		...
		"					indtevtrans = int2(idot(" I_INDTEXMTX"[mtxidx].xyz, indcoord), idot(" I_INDTEXMTX"[mtxidx + 1u].xyz, indcoord));\n"
		"					shift = shift + 3;\n"
		"					break;\n"
