...
bool CalculateTrackingSpaceToViewSpaceMatrix(int kind, Matrix44 &look_matrix)
{
	...
	if (bIsPerspective && !bIsHudElement && !bIsOffscreen)
	{
		...
		look_matrix = rotation_matrix * head_position_matrix * lean_back_matrix * free_look_matrix * camera_pitch_matrix * camera_position_matrix * camera_forward_matrix;
	...
	else
	{
		...
		look_matrix = rotation_matrix * head_position_matrix * lean_back_matrix * free_look_matrix * camera_pitch_matrix * camera_position_matrix * position_matrix * scale_matrix;
	}
	// done
	return true;
}
