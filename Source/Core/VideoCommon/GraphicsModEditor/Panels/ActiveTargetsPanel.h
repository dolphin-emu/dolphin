...
private:
  ...
  SceneRecordingRequest m_last_mesh_dump_request;
  bool m_open_mesh_dump_export_window = false;

  // Vertex group extraction window details
  VertexGroupRecordingRequest m_last_vertex_group_dump_request;
  bool m_open_vertex_group_dump_window = false;
