                             ...
                             GraphicsModSystem::DrawCallID draw_call_id)
{
  ...
  switch (context.skinning_filter)
  {
  case DrawCallFilterContext::SkinningFilter::Any:
    // nop
    break;
  case DrawCallFilterContext::SkinningFilter::CPU:
    filter &= !runtime_iter->second.draw_data.is_gpu_skinning;
    break;
  case DrawCallFilterContext::SkinningFilter::GPU:
    filter &= runtime_iter->second.draw_data.is_gpu_skinning;
    break;
  };
