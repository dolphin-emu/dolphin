...
{
class CommandLineConfigLayerLoader : public Config::ConfigLayerLoader
{
public:
...
std::unique_ptr<optparse::OptionParser> CreateParser(bool gui)
{
  ...
  parser->add_option("-v", "--version").action("version").help("Print version and exit");
...
optparse::Values& ParseArguments(optparse::OptionParser* parser, int argc, char** argv)
{
  ...
  if (config_args.size())
    Config::AddLayer(new CommandLineConfigLayerLoader(config_args,
