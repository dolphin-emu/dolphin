...
bool ShouldHideFromGameList(const std::string& volume_path)
{
  ...
  // If volume_path is inside the /files/ directory of a DirectoryBlob, return true
  ...
  // Below: If volume_path is the /sys/main.dol for a non-game partition, return true
