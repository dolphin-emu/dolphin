...
ECountry CountrySwitch(u8 country_code)
{
  ...
  // Worldwide
  case 'A':
    return ECountry::COUNTRY_WORLD;

  // PAL
  case 'D':
    return ECountry::COUNTRY_GERMANY;
  ...
  case 'U':
    return ECountry::COUNTRY_AUSTRALIA;

  case 'F':
    return ECountry::COUNTRY_FRANCE;

  case 'I':
    return ECountry::COUNTRY_ITALY;

  case 'H':
    return ECountry::COUNTRY_NETHERLANDS;

  case 'R':
    return ECountry::COUNTRY_RUSSIA;

  case 'S':
    return ECountry::COUNTRY_SPAIN;
