...
public:
  ...
  virtual std::optional<std::string> ResolveSavegameRedirectPath(
      std::string_view external_relative_path) = 0;
};
...
public:
  ...
  FileDataLoaderHostFS(
      std::string sd_root, const std::string& xml_path, std::string_view patch_root);
  ...
  std::vector<FileDataLoader::Node> GetFolderContents(
      std::string_view external_relative_path) override;
  ...
  std::optional<std::string> ResolveSavegameRedirectPath(
      std::string_view external_relative_path) override;

private:
  std::optional<std::string> MakeAbsoluteFromRelative(
      std::string_view external_relative_path) const;
