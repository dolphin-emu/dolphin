...
class CNANDContentData_File final : public CNANDContentData
{
public:
	CNANDContentData_File(const std::string& filename) : m_filename(filename) { };
...
class CNANDContentData_Buffer final : public CNANDContentData
{
public:
	CNANDContentData_Buffer(const std::vector<u8>& buffer) : m_buffer(buffer) { };
