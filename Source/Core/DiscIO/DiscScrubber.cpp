...
size_t GetNextBlock(File::IOFile& in, u8* buffer)
{
	...
	{
		DEBUG_LOG(DISCIO, "Freeing 0x%016lx", CurrentOffset);
	...
	{
		DEBUG_LOG(DISCIO, "Used    0x%016lx", CurrentOffset);
...
void MarkAsUsed(u64 _Offset, u64 _Size)
{
	...
	DEBUG_LOG(DISCIO, "Marking 0x%016lx - 0x%016lx as used", _Offset, EndOffset);
