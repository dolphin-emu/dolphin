...
ECountry CVolumeWAD::GetCountry() const
{
  if (!m_pReader)
...
EPlatform CVolumeWAD::GetVolumeType() const
{
  return EPlatform::WII_WAD;
}

std::map<ELanguage, std::string> CVolumeWAD::GetLongNames() const
{
