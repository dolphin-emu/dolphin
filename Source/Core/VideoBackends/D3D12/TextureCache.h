...
private:
  struct TCacheEntry : TCacheEntryBase {
    ...
    void FromRenderTarget(u8 *dst, PEControl::PixelFormat src_format,
  ...
  u64 EncodeToRamFromTexture(u32 address, void *source_texture,
                             u32 source_width, u32 source_height,
                             bool is_from_z_buffer, bool is_intensity_format,
                             u32 copy_format, int scale_by_half,
