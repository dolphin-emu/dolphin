...
VertexManager::VertexManager()
{
	...
	m_vertex_stream_buffer->AllocateSpaceInBuffer(MAXVBUFFERSIZE, 0);

	s_pCurBufferPointer = s_pBaseBufferPointer = static_cast<u8*>(m_vertex_stream_buffer->GetBaseCPUAddress());
