...
namespace DX12 {
template <typename T> constexpr size_t BufferOffsetForQueueItemType() {
  return sizeof(T) + sizeof(D3DQueueItemType) * 2;
}

void ID3D12QueuedCommandList::BackgroundThreadFunction(
    ID3D12QueuedCommandList *parent_queued_command_list) {
  ID3D12GraphicsCommandList *command_list =
      parent_queued_command_list->m_command_list;
  ...
  while (true) {
    WaitForSingleObject(parent_queued_command_list->m_begin_execution_event,
                        INFINITE);
    ...
    while (true) {
      ...
      case D3DQueueItemType::ClearDepthStencilView: {
        command_list->ClearDepthStencilView(
            reinterpret_cast<D3DQueueItem *>(item)
      ...
      case D3DQueueItemType::ClearRenderTargetView: {
        ...
        command_list->ClearRenderTargetView(
            reinterpret_cast<D3DQueueItem *>(item)
                ->ClearRenderTargetView.RenderTargetView,
      ...
      case D3DQueueItemType::CopyTextureRegion: {
        // If box is completely empty, assume that the original API call has a
        // NULL box (which means
        // copy from the entire resource.

        D3D12_BOX *src_box =
            &reinterpret_cast<D3DQueueItem *>(item)->CopyTextureRegion.srcBox;

        // Front/Back never used, so don't need to check.
        bool empty_box = src_box->bottom == 0 && src_box->left == 0 &&
                         src_box->right == 0 && src_box->top == 0;
      ...
      case D3DQueueItemType::DrawIndexedInstanced: {
        command_list->DrawIndexedInstanced(
            reinterpret_cast<D3DQueueItem *>(item)
                ->DrawIndexedInstanced.IndexCount,
            1, reinterpret_cast<D3DQueueItem *>(item)
                   ->DrawIndexedInstanced.StartIndexLocation,
            reinterpret_cast<D3DQueueItem *>(item)
                ->DrawIndexedInstanced.BaseVertexLocation,
            0);
      ...
      case D3DQueueItemType::DrawInstanced: {
        command_list->DrawInstanced(
            ...
            1, reinterpret_cast<D3DQueueItem *>(item)
                   ->DrawInstanced.StartVertexLocation,
            0);
      ...
      case D3DQueueItemType::ResourceBarrier: {
        command_list->ResourceBarrier(
            1,
            &reinterpret_cast<D3DQueueItem *>(item)->ResourceBarrier.barrier);
      ...
      case D3DQueueItemType::SetDescriptorHeaps: {
        command_list->SetDescriptorHeaps(
            reinterpret_cast<D3DQueueItem *>(item)
                ->SetDescriptorHeaps.NumDescriptorHeaps,
            reinterpret_cast<D3DQueueItem *>(item)
                ->SetDescriptorHeaps.ppDescriptorHeap);
      ...
      case D3DQueueItemType::SetGraphicsRootConstantBufferView: {
        command_list->SetGraphicsRootConstantBufferView(
            reinterpret_cast<D3DQueueItem *>(item)
                ->SetGraphicsRootConstantBufferView.RootParameterIndex,
            reinterpret_cast<D3DQueueItem *>(item)
                ->SetGraphicsRootConstantBufferView.BufferLocation);

        item += BufferOffsetForQueueItemType<
      ...
      case D3DQueueItemType::SetGraphicsRootDescriptorTable: {
        command_list->SetGraphicsRootDescriptorTable(
            reinterpret_cast<D3DQueueItem *>(item)
                ->SetGraphicsRootDescriptorTable.RootParameterIndex,
            reinterpret_cast<D3DQueueItem *>(item)
                ->SetGraphicsRootDescriptorTable.BaseDescriptor);
      ...
      case D3DQueueItemType::SetGraphicsRootSignature: {
        ...
        item +=
            BufferOffsetForQueueItemType<SetGraphicsRootSignatureArguments>();
        break;
      }
      ...
      case D3DQueueItemType::SetPipelineState: {
        command_list->SetPipelineState(
            reinterpret_cast<D3DQueueItem *>(item)
                ->SetPipelineState.pPipelineStateObject);
      ...
      case D3DQueueItemType::SetRenderTargets: {
        ...
        if (reinterpret_cast<D3DQueueItem *>(item)
                ->SetRenderTargets.RenderTargetDescriptor.ptr) {
          render_target_count = 1;
        }

        command_list->OMSetRenderTargets(
            render_target_count,
            reinterpret_cast<D3DQueueItem *>(
                item)->SetRenderTargets.RenderTargetDescriptor.ptr == NULL
                ? nullptr
                : &reinterpret_cast<D3DQueueItem *>(item)
                       ->SetRenderTargets.RenderTargetDescriptor,
            FALSE,
            reinterpret_cast<D3DQueueItem *>(
                item)->SetRenderTargets.DepthStencilDescriptor.ptr == NULL
                ? nullptr
                : &reinterpret_cast<D3DQueueItem *>(item)
                       ->SetRenderTargets.DepthStencilDescriptor);
      ...
      case D3DQueueItemType::ResolveSubresource: {
        command_list->ResolveSubresource(
            reinterpret_cast<D3DQueueItem *>(item)
                ->ResolveSubresource.pDstResource,
            reinterpret_cast<D3DQueueItem *>(item)
                ->ResolveSubresource.DstSubresource,
            reinterpret_cast<D3DQueueItem *>(item)
                ->ResolveSubresource.pSrcResource,
            reinterpret_cast<D3DQueueItem *>(item)
                ->ResolveSubresource.SrcSubresource,
      ...
      case D3DQueueItemType::ResolveQueryData: {
        command_list->ResolveQueryData(
            ...
            reinterpret_cast<D3DQueueItem *>(item)
                ->ResolveQueryData.StartElement,
            reinterpret_cast<D3DQueueItem *>(item)
                ->ResolveQueryData.ElementCount,
            reinterpret_cast<D3DQueueItem *>(item)
                ->ResolveQueryData.pDestinationBuffer,
            reinterpret_cast<D3DQueueItem *>(item)
                ->ResolveQueryData.AlignedDestinationBufferOffset);
      ...
      case D3DQueueItemType::ExecuteCommandList: {
        parent_queued_command_list->m_command_queue->ExecuteCommandLists(
      ...
      case D3DQueueItemType::Present: {
        CheckHR(
            reinterpret_cast<D3DQueueItem *>(item)->Present.swapChain->Present(
                reinterpret_cast<D3DQueueItem *>(item)->Present.syncInterval,
                reinterpret_cast<D3DQueueItem *>(item)->Present.flags));
      ...
      case D3DQueueItemType::ResetCommandList: {
        CheckHR(command_list->Reset(
            reinterpret_cast<D3DQueueItem *>(item)->ResetCommandList.allocator,
            nullptr));
      ...
      case D3DQueueItemType::ResetCommandAllocator: {
        CheckHR(reinterpret_cast<D3DQueueItem *>(item)
                    ->ResetCommandAllocator.allocator->Reset());
      ...
      case D3DQueueItemType::FenceGpuSignal: {
        CheckHR(parent_queued_command_list->m_command_queue->Signal(
            reinterpret_cast<D3DQueueItem *>(item)->FenceGpuSignal.fence,
            reinterpret_cast<D3DQueueItem *>(item)
                ->FenceGpuSignal.fence_value));
      ...
      case D3DQueueItemType::FenceCpuSignal: {
        CheckHR(reinterpret_cast<D3DQueueItem *>(item)
                    ->FenceCpuSignal.fence->Signal(
                        reinterpret_cast<D3DQueueItem *>(item)
                            ->FenceCpuSignal.fence_value));
      ...
      case D3DQueueItemType::Stop:
        ...
        // Use a goto to break out of the loop, since we can't exit the loop
        // from
        // within a switch statement. We could use a separate 'if' after the
        // switch,
        // but that was the highest source of overhead in the function after
        // profiling.
        ...
        bool eligible_to_move_to_front_of_queue =
            reinterpret_cast<D3DQueueItem *>(item)
                ->Stop.eligible_to_move_to_front_of_queue;
        bool signal_stop_event =
            reinterpret_cast<D3DQueueItem *>(item)->Stop.signal_stop_event;
        bool terminate_worker_thread = reinterpret_cast<D3DQueueItem *>(item)
                                           ->Stop.terminate_worker_thread;

        item += BufferOffsetForQueueItemType<StopArguments>();

        if (eligible_to_move_to_front_of_queue &&
            item - queue_array > QUEUE_ARRAY_SIZE * 2 / 3) {
          item = queue_array;
        }
...
ID3D12QueuedCommandList::ID3D12QueuedCommandList(
    ID3D12GraphicsCommandList *backing_command_list,
...
void ID3D12QueuedCommandList::CheckForOverflow() {
  constexpr const unsigned int queue_space_allowed_per_frame =
      QUEUE_ARRAY_SIZE / 3;

  if (m_queue_array_back - m_queue_array_back_at_start_of_frame >
      queue_space_allowed_per_frame) {
...
void ID3D12QueuedCommandList::QueueExecute() {
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::ExecuteCommandList;

  m_queue_array_back +=
      BufferOffsetForQueueItemType<ExecuteCommandListArguments>();

  CheckForOverflow();
}

void ID3D12QueuedCommandList::QueueFenceGpuSignal(ID3D12Fence *fence_to_signal,
                                                  UINT64 fence_value) {
  D3DQueueItem item = {};
...
void ID3D12QueuedCommandList::QueueFenceCpuSignal(ID3D12Fence *fence_to_signal,
                                                  UINT64 fence_value) {
  D3DQueueItem item = {};
...
void ID3D12QueuedCommandList::QueuePresent(IDXGISwapChain *swap_chain,
...
void ID3D12QueuedCommandList::ProcessQueuedItems(
    bool eligible_to_move_to_front_of_queue, bool wait_for_stop,
    bool terminate_worker_thread) {
  D3DQueueItem item = {};

  item.Type = D3DQueueItemType::Stop;
  item.Stop.eligible_to_move_to_front_of_queue =
      eligible_to_move_to_front_of_queue;
  ...
  *reinterpret_cast<D3DQueueItem *>(m_queue_array_back) = item;
  ...
  // Only (possibly) move to front of queue when finishing a frame, or when
  // draining GPU queue.
  // Logic in ID3D12QueuedCommandList::CheckForOverflow
  // ensures that not more than one third of queue is used per frame.
  if (eligible_to_move_to_front_of_queue &&
      (m_queue_array_back - m_queue_array > QUEUE_ARRAY_SIZE * 2 / 3)) {
    m_queue_array_back = m_queue_array;
  }
...
HRESULT STDMETHODCALLTYPE ID3D12QueuedCommandList::GetPrivateData(
    _In_ REFGUID guid, _Inout_ UINT *pDataSize,
...
HRESULT STDMETHODCALLTYPE ID3D12QueuedCommandList::SetPrivateData(
    _In_ REFGUID guid, _In_ UINT DataSize,
...
ID3D12QueuedCommandList::SetName(_In_z_ LPCWSTR pName) {
  // Function not implemented yet.
  DEBUGCHECK(0, "Function not implemented yet.");
  return E_FAIL;
}
...
HRESULT STDMETHODCALLTYPE
ID3D12QueuedCommandList::GetDevice(REFIID riid, _Out_ void **ppDevice) {
  return m_command_list->GetDevice(riid, ppDevice);
}

HRESULT STDMETHODCALLTYPE ID3D12QueuedCommandList::Close() {
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::CloseCommandList;

  m_queue_array_back +=
      BufferOffsetForQueueItemType<CloseCommandListArguments>();
...
HRESULT STDMETHODCALLTYPE
ID3D12QueuedCommandList::Reset(_In_ ID3D12CommandAllocator *pAllocator,
                               _In_opt_ ID3D12PipelineState *pInitialState) {
  DEBUGCHECK(pInitialState == nullptr,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");

  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::ResetCommandList;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ResetCommandList.allocator = pAllocator;

  m_queue_array_back +=
      BufferOffsetForQueueItemType<ResetCommandListArguments>();
...
ID3D12QueuedCommandList::ClearState(_In_ ID3D12PipelineState *pPipelineState) {
  // Function not implemented yet.
  DEBUGCHECK(0, "Function not implemented yet.");
}
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::DrawInstanced(
  ...
  DEBUGCHECK(InstanceCount == 1,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");
  DEBUGCHECK(StartInstanceLocation == 0,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");

  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::DrawInstanced;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->DrawInstanced.StartVertexLocation = StartVertexLocation;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->DrawInstanced.VertexCount = VertexCountPerInstance;
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::DrawIndexedInstanced(
  ...
  m_queue_array_back +=
      BufferOffsetForQueueItemType<DrawIndexedInstancedArguments>();
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::DispatchIndirect(
    _In_ ID3D12Resource *pBufferForArgs, _In_ UINT AlignedByteOffsetForArgs) {
  // Function not implemented yet.
  DEBUGCHECK(0, "Function not implemented yet.");
}

void STDMETHODCALLTYPE ID3D12QueuedCommandList::CopyBufferRegion(
    _In_ ID3D12Resource *pDstBuffer, UINT64 DstOffset,
    _In_ ID3D12Resource *pSrcBuffer, UINT64 SrcOffset, UINT64 NumBytes) {
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::CopyBufferRegion;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->CopyBufferRegion.pDstBuffer = pDstBuffer;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->CopyBufferRegion.DstOffset = static_cast<UINT>(DstOffset);
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->CopyBufferRegion.pSrcBuffer = pSrcBuffer;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->CopyBufferRegion.SrcOffset = static_cast<UINT>(SrcOffset);
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->CopyBufferRegion.NumBytes = static_cast<UINT>(NumBytes);

  m_queue_array_back +=
      BufferOffsetForQueueItemType<CopyBufferRegionArguments>();
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::CopyTextureRegion(
  ...
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::CopyTextureRegion;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->CopyTextureRegion.dst =
      *pDst;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->CopyTextureRegion.src =
      *pSrc;

  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->CopyTextureRegion.DstX =
      DstX;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->CopyTextureRegion.DstY =
      DstY;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->CopyTextureRegion.DstZ =
      DstZ;

  if (pSrcBox)
    reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
        ->CopyTextureRegion.srcBox = *pSrcBox;
  else
    reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
        ->CopyTextureRegion.srcBox = {};

  m_queue_array_back +=
      BufferOffsetForQueueItemType<CopyTextureRegionArguments>();

  CheckForOverflow();
}

void STDMETHODCALLTYPE ID3D12QueuedCommandList::CopyResource(
    _In_ ID3D12Resource *pDstResource, _In_ ID3D12Resource *pSrcResource) {
  // Function not implemented yet.
  DEBUGCHECK(0, "Function not implemented yet.");
}
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::CopyTiles(
    ...
    _In_ ID3D12Resource *pBuffer, UINT64 BufferStartOffsetInBytes,
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::ResolveSubresource(
  ...
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::ResolveSubresource;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ResolveSubresource.pDstResource = pDstResource;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ResolveSubresource.DstSubresource = DstSubresource;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ResolveSubresource.pSrcResource = pSrcResource;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ResolveSubresource.SrcSubresource = SrcSubresource;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ResolveSubresource.Format = Format;

  m_queue_array_back +=
      BufferOffsetForQueueItemType<ResolveSubresourceArguments>();
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::IASetPrimitiveTopology(
  ...
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::IASetPrimitiveTopology;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->IASetPrimitiveTopology.PrimitiveTopology = PrimitiveTopology;

  m_queue_array_back +=
      BufferOffsetForQueueItemType<IASetPrimitiveTopologyArguments>();
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::RSSetViewports(
  ...
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::RSSetViewports;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->RSSetViewports.Height =
      pViewports->Height;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->RSSetViewports.Width =
      pViewports->Width;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->RSSetViewports.TopLeftX = pViewports->TopLeftX;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->RSSetViewports.TopLeftY = pViewports->TopLeftY;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->RSSetViewports.MinDepth = pViewports->MinDepth;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->RSSetViewports.MaxDepth = pViewports->MaxDepth;
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::RSSetScissorRects(
  ...
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::RSSetScissorRects;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->RSSetScissorRects.bottom = pRects->bottom;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->RSSetScissorRects.left =
      pRects->left;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->RSSetScissorRects.right = pRects->right;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->RSSetScissorRects.top =
      pRects->top;

  m_queue_array_back +=
      BufferOffsetForQueueItemType<RSSetScissorRectsArguments>();

  CheckForOverflow();
}

void STDMETHODCALLTYPE
ID3D12QueuedCommandList::OMSetBlendFactor(_In_opt_ const FLOAT BlendFactor[4]) {
  // Function not implemented yet.
  DEBUGCHECK(0, "Function not implemented yet.");
}

void STDMETHODCALLTYPE
ID3D12QueuedCommandList::OMSetStencilRef(_In_ UINT StencilRef) {
  // Function not implemented yet.
  DEBUGCHECK(0, "Function not implemented yet.");
}
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::SetPipelineState(
  ...
  m_queue_array_back +=
      BufferOffsetForQueueItemType<SetPipelineStateArguments>();
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::ResourceBarrier(
  ...
  DEBUGCHECK(NumBarriers == 1,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");

  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::ResourceBarrier;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ResourceBarrier.barrier = *pBarriers;

  m_queue_array_back +=
      BufferOffsetForQueueItemType<ResourceBarrierArguments>();
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::BeginQuery(
    _In_ ID3D12QueryHeap *pQueryHeap, _In_ D3D12_QUERY_TYPE Type,
    _In_ UINT Index) {
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::BeginQuery;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->BeginQuery.pQueryHeap =
      pQueryHeap;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->BeginQuery.Type = Type;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->BeginQuery.Index =
      Index;
...
void STDMETHODCALLTYPE
ID3D12QueuedCommandList::EndQuery(_In_ ID3D12QueryHeap *pQueryHeap,
                                  _In_ D3D12_QUERY_TYPE Type, _In_ UINT Index) {
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::EndQuery;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->EndQuery.pQueryHeap =
      pQueryHeap;
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::ResolveQueryData(
    _In_ ID3D12QueryHeap *pQueryHeap, _In_ D3D12_QUERY_TYPE Type,
    _In_ UINT StartElement, _In_ UINT ElementCount,
    _In_ ID3D12Resource *pDestinationBuffer,
    _In_ UINT64 AlignedDestinationBufferOffset) {
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::ResolveQueryData;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ResolveQueryData.pQueryHeap = pQueryHeap;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->ResolveQueryData.Type =
      Type;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ResolveQueryData.StartElement = StartElement;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ResolveQueryData.ElementCount = ElementCount;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ResolveQueryData.pDestinationBuffer = pDestinationBuffer;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ResolveQueryData.AlignedDestinationBufferOffset =
      AlignedDestinationBufferOffset;

  m_queue_array_back +=
      BufferOffsetForQueueItemType<ResolveQueryDataArguments>();
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::SetDescriptorHeaps(
  ...
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::SetDescriptorHeaps;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->SetDescriptorHeaps.ppDescriptorHeap = pDescriptorHeaps;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->SetDescriptorHeaps.NumDescriptorHeaps = NumDescriptorHeaps;

  m_queue_array_back +=
      BufferOffsetForQueueItemType<SetDescriptorHeapsArguments>();
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::SetGraphicsRootSignature(
  ...
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::SetGraphicsRootSignature;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->SetGraphicsRootSignature.pRootSignature = pRootSignature;
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::SetGraphicsRootDescriptorTable(
  ...
  m_queue_array_back +=
      BufferOffsetForQueueItemType<SetGraphicsRootDescriptorTableArguments>();
...
void STDMETHODCALLTYPE
ID3D12QueuedCommandList::SetGraphicsRootConstantBufferView(
    _In_ UINT RootParameterIndex,
  ...
  item->SetGraphicsRootConstantBufferView.RootParameterIndex =
      RootParameterIndex;
  item->SetGraphicsRootConstantBufferView.BufferLocation = BufferLocation;

  m_queue_array_back += BufferOffsetForQueueItemType<
      SetGraphicsRootConstantBufferViewArguments>();
...
void STDMETHODCALLTYPE
ID3D12QueuedCommandList::SetComputeRootConstantBufferView(
    _In_ UINT RootParameterIndex,
    _In_ D3D12_GPU_VIRTUAL_ADDRESS BufferLocation) {
  // Function not implemented yet.
  DEBUGCHECK(0, "Function not implemented yet.");
...
void STDMETHODCALLTYPE
ID3D12QueuedCommandList::SetComputeRootShaderResourceView(
    _In_ UINT RootParameterIndex,
...
void STDMETHODCALLTYPE
ID3D12QueuedCommandList::SetGraphicsRootShaderResourceView(
    _In_ UINT RootParameterIndex,
    _In_ D3D12_GPU_VIRTUAL_ADDRESS DescriptorHandle) {
  // Function not implemented yet.
  DEBUGCHECK(0, "Function not implemented yet.");
...
void STDMETHODCALLTYPE
ID3D12QueuedCommandList::SetComputeRootUnorderedAccessView(
    _In_ UINT RootParameterIndex,
    _In_ D3D12_GPU_VIRTUAL_ADDRESS DescriptorHandle) {
  // Function not implemented yet.
  DEBUGCHECK(0, "Function not implemented yet.");
...
void STDMETHODCALLTYPE
ID3D12QueuedCommandList::SetGraphicsRootUnorderedAccessView(
    _In_ UINT RootParameterIndex,
    _In_ D3D12_GPU_VIRTUAL_ADDRESS DescriptorHandle) {
  // Function not implemented yet.
  DEBUGCHECK(0, "Function not implemented yet.");
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::IASetIndexBuffer(
  ...
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::SetIndexBuffer;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->SetIndexBuffer.desc =
      *pDesc;
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::IASetVertexBuffers(
    _In_ UINT StartSlot, _In_ UINT NumBuffers,
    _In_ const D3D12_VERTEX_BUFFER_VIEW *pDesc) {
  DEBUGCHECK(StartSlot == 0,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");
  DEBUGCHECK(NumBuffers == 1,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");

  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::SetVertexBuffers;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->SetVertexBuffers.desc =
      *pDesc;

  m_queue_array_back +=
      BufferOffsetForQueueItemType<SetVertexBuffersArguments>();

  CheckForOverflow();
}

void STDMETHODCALLTYPE ID3D12QueuedCommandList::SOSetTargets(
    _In_ UINT StartSlot, _In_ UINT NumViews,
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::OMSetRenderTargets(
  ...
  DEBUGCHECK(RTsSingleHandleToDescriptorRange == FALSE,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");

  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::SetRenderTargets;

  if (pRenderTargetDescriptors)
    reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
        ->SetRenderTargets.RenderTargetDescriptor = *pRenderTargetDescriptors;
  else
    reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
        ->SetRenderTargets.RenderTargetDescriptor = {};
  ...
  if (pDepthStencilDescriptor)
    reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
        ->SetRenderTargets.DepthStencilDescriptor = *pDepthStencilDescriptor;
  else
    reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
        ->SetRenderTargets.DepthStencilDescriptor = {};

  m_queue_array_back +=
      BufferOffsetForQueueItemType<SetRenderTargetsArguments>();
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::ClearDepthStencilView(
    ...
    _In_ D3D12_CLEAR_FLAGS ClearFlags, _In_ FLOAT Depth, _In_ UINT8 Stencil,
    _In_ UINT NumRects, _In_reads_opt_(NumRects) const D3D12_RECT *pRect) {
  DEBUGCHECK(ClearFlags == D3D12_CLEAR_FLAG_DEPTH,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");
  DEBUGCHECK(Depth == 0.0f,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");
  DEBUGCHECK(Stencil == 0,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");
  DEBUGCHECK(pRect == nullptr,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");
  DEBUGCHECK(NumRects == 0,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");

  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::ClearDepthStencilView;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ClearDepthStencilView.DepthStencilView = DepthStencilView;

  m_queue_array_back +=
      BufferOffsetForQueueItemType<ClearDepthStencilViewArguments>();
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::ClearRenderTargetView(
  ...
  DEBUGCHECK(ColorRGBA[0] == 0.0f,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");
  DEBUGCHECK(ColorRGBA[1] == 0.0f,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");
  DEBUGCHECK(ColorRGBA[2] == 0.0f,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");
  DEBUGCHECK(ColorRGBA[3] == 1.0f,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");
  DEBUGCHECK(pRects == nullptr,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");
  DEBUGCHECK(NumRects == 0,
             "Error: Invalid assumption in ID3D12QueuedCommandList.");

  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)->Type =
      D3DQueueItemType::ClearRenderTargetView;
  reinterpret_cast<D3DQueueItem *>(m_queue_array_back)
      ->ClearRenderTargetView.RenderTargetView = RenderTargetView;

  m_queue_array_back +=
      BufferOffsetForQueueItemType<ClearRenderTargetViewArguments>();
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::ClearUnorderedAccessViewUint(
    ...
    _In_ UINT NumRects, _In_reads_opt_(NumRects) const D3D12_RECT *pRects) {
  // Function not implemented yet.
  DEBUGCHECK(0, "Function not implemented yet.");
}
...
void STDMETHODCALLTYPE ID3D12QueuedCommandList::SetMarker(
    UINT Metadata, _In_reads_bytes_opt_(Size) const void *pData, UINT Size) {
  // Function not implemented yet.
  DEBUGCHECK(0, "Function not implemented yet.");
}
