...
static constexpr unsigned int MAX_BYTES_PER_ENCODE =
    MAX_BYTES_PER_BLOCK_ROW * (EFB_HEIGHT / 4);
...
public:
  ...
  virtual void Encode(u8 *dst, u32 format, u32 native_width, u32 bytes_per_row,
