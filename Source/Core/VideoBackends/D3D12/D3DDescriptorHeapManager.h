...
public:
  D3DDescriptorHeapManager(D3D12_DESCRIPTOR_HEAP_DESC *desc,
                           ID3D12Device *device,
  ...
  bool
  AllocateGroup(D3D12_CPU_DESCRIPTOR_HANDLE *cpu_handles,
  ...
  GetHandleForSamplerGroup(SamplerState *sampler_state,
...
private:
  ...
  std::unordered_map<SamplerStateSet, D3D12_GPU_DESCRIPTOR_HANDLE,
                     hash_sampler_desc>
      m_sampler_map;
