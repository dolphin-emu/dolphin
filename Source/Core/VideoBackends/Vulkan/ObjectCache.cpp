...
VkSampler ObjectCache::GetSampler(const SamplerState& info)
{
  ...
  VkSamplerCreateInfo create_info = {
      ...
      nullptr,                                      // const void*             pNext
      0,                                            // VkSamplerCreateFlags    flags
      filters[u32(info.tm0.mag_filter())],          // VkFilter                magFilter
      filters[u32(info.tm0.min_filter())],          // VkFilter                minFilter
      mipmap_modes[u32(info.tm0.mipmap_filter())],  // VkSamplerMipmapMode     mipmapMode
      address_modes[u32(info.tm0.wrap_u())],        // VkSamplerAddressMode    addressModeU
      address_modes[u32(info.tm0.wrap_v())],        // VkSamplerAddressMode    addressModeV
      VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE,        // VkSamplerAddressMode    addressModeW
