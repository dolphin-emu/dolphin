...
#define VULKAN_INSTANCE_ENTRY_POINT(name, required) LoadFunction(reinterpret_cast<PFN_vkVoidFunction*>(&name), #name, required);
#include "VideoBackends/Vulkan/VulkanImports.inl"
#undef VULKAN_INSTANCE_ENTRY_POINT
...
#define VULKAN_DEVICE_ENTRY_POINT(name, required) LoadFunction(reinterpret_cast<PFN_vkVoidFunction*>(&name), #name, required);
#include "VideoBackends/Vulkan/VulkanImports.inl"
#undef VULKAN_DEVICE_ENTRY_POINT
