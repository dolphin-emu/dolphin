...
enum
{
  ...
  NUM_PIXEL_SHADER_SAMPLERS = 8,
  TOTAL_PIPELINE_BINDING_POINTS = NUM_UBO_DESCRIPTOR_SET_BINDINGS + NUM_PIXEL_SHADER_SAMPLERS + 1,
  INITIAL_TEXTURE_UPLOAD_BUFFER_SIZE = 16 * 1024 * 1024,
  MAXIMUM_TEXTURE_UPLOAD_BUFFER_SIZE = 64 * 1024 * 1024,
  STAGING_TEXTURE_UPLOAD_THRESHOLD = 1024 * 1024 * 4,
  INITIAL_UNIFORM_STREAM_BUFFER_SIZE = 16 * 1024 * 1024,
  MAXIMUM_UNIFORM_STREAM_BUFFER_SIZE = 32 * 1024 * 1024,
  PUSH_CONSTANT_BUFFER_SIZE = 128,
};
#else
