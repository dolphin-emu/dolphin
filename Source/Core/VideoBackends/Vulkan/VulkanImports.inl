...
VULKAN_INSTANCE_ENTRY_POINT(vkDestroySurfaceKHR, true)
VULKAN_INSTANCE_ENTRY_POINT(vkGetPhysicalDeviceSurfaceSupportKHR, true)
VULKAN_INSTANCE_ENTRY_POINT(vkGetPhysicalDeviceSurfaceCapabilitiesKHR, true)
VULKAN_INSTANCE_ENTRY_POINT(vkGetPhysicalDeviceSurfaceFormatsKHR, true)
VULKAN_INSTANCE_ENTRY_POINT(vkGetPhysicalDeviceSurfacePresentModesKHR, true)

#if defined(VK_USE_PLATFORM_WIN32_KHR)

VULKAN_INSTANCE_ENTRY_POINT(vkCreateWin32SurfaceKHR, true)
VULKAN_INSTANCE_ENTRY_POINT(vkGetPhysicalDeviceWin32PresentationSupportKHR, true)
...
VULKAN_DEVICE_ENTRY_POINT(vkCreateSwapchainKHR, true)
VULKAN_DEVICE_ENTRY_POINT(vkDestroySwapchainKHR, true)
VULKAN_DEVICE_ENTRY_POINT(vkGetSwapchainImagesKHR, true)
VULKAN_DEVICE_ENTRY_POINT(vkAcquireNextImageKHR, true)
VULKAN_DEVICE_ENTRY_POINT(vkQueuePresentKHR, true)
