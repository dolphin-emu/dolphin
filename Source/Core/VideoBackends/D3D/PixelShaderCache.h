...
public:
  ...
  static bool SetShader(
      DSTALPHA_MODE dstAlphaMode); // TODO: Should be renamed to LoadShader
  static bool InsertByteCode(const UberShader::PixelShaderUid &uid,
                             const void *bytecode, unsigned int bytecodelen);
