...
void InitBackendInfo()
{
	...
	{
		const auto adapter_index = g_Config.backend_info.Adapters.size();
		...
		if (adapter_index == g_Config.iAdapter)
		{
			...
			auto shader_model_5_supported = (D3D::GetFeatureLevel(ad) >= D3D_FEATURE_LEVEL_11_0);
