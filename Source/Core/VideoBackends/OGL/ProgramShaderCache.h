...
public:
  ...
  static void GetShaderId(SHADERUID *uid, DSTALPHA_MODE dstAlphaMode,
                          u32 primitive_type);

  static bool CompileShader(SHADER &shader, const std::string &vcode,
...
private:
  class ProgramShaderCacheInserter
      : public LinearDiskCacheReader<SHADERUID, u8> {
  public:
