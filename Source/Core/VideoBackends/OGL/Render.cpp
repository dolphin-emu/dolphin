...
void Renderer::SwapImpl(u32 xfbAddr, u32 fbWidth, u32 fbStride, u32 fbHeight, const EFBRectangle& rc, float Gamma)
{
	...
	BlitScreen(sourceRc, flipped_trc, opengl_entry->texture, opengl_entry->config.width, opengl_entry->config.height);

	// Tell the OSD Menu about the current internal resolution
	OSDInternalW = sourceRc.GetWidth(); OSDInternalH = sourceRc.GetHeight();
