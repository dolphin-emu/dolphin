...
public:
  ...
  void ConvertTexture(TCacheEntryBase *entry, TCacheEntryBase *unconverted,
                      void *palette, TlutFormat format) override{};
  void CopyEFB(u8 *dst, u32 format, u32 native_width, u32 bytes_per_row,
...
private:
  struct TCacheEntry : TCacheEntryBase {
    ...
    void FromRenderTarget(u8 *dst, PEControl::PixelFormat srcFormat,
    ...
    void
    CopyRectangleFromTexture(const TCacheEntryBase *source,
...
class FramebufferManager : public FramebufferManagerBase {
  ...
  void CopyToRealXFB(u32 xfbAddr, u32 fbStride, u32 fbHeight,
...
std::string VideoSoftware::GetName() const { return "Software Renderer"; }
