...
KeyboardWindow::KeyboardWindow(QWidget* parent) : QWidget(parent)
{
...

  {
    ...
    auto* checkbox_translate = new QCheckBox(tr("Enable partial translation"), this);
    checkbox_translate->setChecked(Config::Get(Config::MAIN_WII_KEYBOARD_TRANSLATION));
    connect(checkbox_translate, &QCheckBox::toggled, this, &KeyboardWindow::EnableTranslation);
...
void KeyboardWindow::EnableTranslation(bool enable) const
{
  Config::SetBaseOrCurrent(Config::MAIN_WII_KEYBOARD_TRANSLATION, enable);
}
