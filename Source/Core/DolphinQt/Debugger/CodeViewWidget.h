...
private:
  ...
  void OnFollowBranch();
  void OnCopyAddress() const;
  void OnCopyTargetAddress() const;
  void OnShowInMemory();
  void OnShowTargetInMemory();
  void OnCopyFunction() const;
  void OnCopyCode() const;
  void OnCopyHex() const;
  void OnRenameSymbol();
  void OnSelectionChanged();
  void OnSetSymbolSize();
  void OnSetSymbolEndAddress();
  void OnRunToHere() const;
  void OnAddFunction() const;
