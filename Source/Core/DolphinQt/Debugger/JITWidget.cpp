...
JITWidget::JITWidget(Core::System& system, QWidget* parent) : QDockWidget(parent), m_system(system)
{
  ...
  m_toggle_profiling_button = new QPushButton(this);
  ...
  m_clear_cache_button = new QPushButton(tr("Clear Cache"), this);
  ...
  m_wipe_profiling_button = new QPushButton(tr("Wipe Profiling"), this);
  ...
  m_disasm_splitter = new QSplitter(Qt::Horizontal, this);
  ...
  text_box_routine(m_ppc_asm_widget = new QPlainTextEdit(this), tr("PPC Instruction Coverage"));
  text_box_routine(m_host_near_asm_widget = new QPlainTextEdit(this), tr("Host Near Code Cache"));
  text_box_routine(m_host_far_asm_widget = new QPlainTextEdit(this), tr("Host Far Code Cache"));

  m_table_splitter = new QSplitter(Qt::Vertical, this);
  m_table_splitter->addWidget(m_table_view);
  m_table_splitter->addWidget(m_disasm_splitter);

  m_status_bar = new ClickableStatusBar(this);
  ...
  auto* const main_widget = new QWidget(this);
