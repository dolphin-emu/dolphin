...
QIcon Resources::GetIcon(const std::string_view name, const QString& dir)
{
...
QPixmap Resources::GetPixmap(const std::string_view name, const QString& dir)
{
...
QIcon Resources::GetScaledIcon(const std::string_view name)
{
  return GetIcon(name, GetResourcesDir());
}

QIcon Resources::GetScaledThemeIcon(const std::string_view name)
{
  return GetIcon(name, GetCurrentThemeDir());
}

QPixmap Resources::GetScaledPixmap(const std::string_view name)
{
