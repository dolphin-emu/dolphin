...
void MainWindow::StateSave()
{
  ...
  Config::SetBase(Config::MAIN_CURRENT_STATE_PATH, QFileInfo(path).dir().path().toStdString());
  if (!path.isEmpty())
    State::SaveAs(Core::CPUThreadGuard{Core::System::GetInstance()}, path.toStdString());
}

void MainWindow::StateLoadSlot()
{
  State::Load(Core::CPUThreadGuard{Core::System::GetInstance()}, m_state_slot);
}

void MainWindow::StateSaveSlot()
{
  State::Save(Core::CPUThreadGuard{Core::System::GetInstance()}, m_state_slot);
}

void MainWindow::StateLoadSlotAt(int slot)
{
  State::Load(Core::CPUThreadGuard{Core::System::GetInstance()}, slot);
}

void MainWindow::StateLoadLastSavedAt(int slot)
{
  State::LoadLastSaved(Core::CPUThreadGuard{Core::System::GetInstance()}, slot);
}

void MainWindow::StateSaveSlotAt(int slot)
{
  State::Save(Core::CPUThreadGuard{Core::System::GetInstance()}, slot);
}
...
{
  State::SaveFirstSaved(Core::CPUThreadGuard{Core::System::GetInstance()});
}
