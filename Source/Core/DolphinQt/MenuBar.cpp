...
void MenuBar::AddToolsMenu()
{
  ...
  dme->addAction(tr("Import from Cheat Engine's CT file..."), this,
  ...
  connect(m_viewDMEScanner, &QAction::toggled, this,
          [this] { emit DMEShowScanner(m_viewDMEScanner->isChecked()); });
