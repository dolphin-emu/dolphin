...
CheatWarningWidget::CheatWarningWidget(
    const std::string& game_id, bool restart_required, QWidget* parent)
    : QWidget(parent)
    , m_game_id(game_id)
...
{
  connect(
      m_config_button, &QPushButton::clicked, this, &CheatWarningWidget::OpenCheatEnableSettings);
}
