...
void HotkeyControllerProfile::CreateMainLayout()
{
  ...
  main_layout->addWidget(CreateGroupBox(tr("Wii Remote %1").arg(1),
                             HotkeyManagerEmu::GetHotkeyGroup(HKGP_CONTROLLER_PROFILE_1)),
      0, 0);

  main_layout->addWidget(CreateGroupBox(tr("Wii Remote %1").arg(2),
                             HotkeyManagerEmu::GetHotkeyGroup(HKGP_CONTROLLER_PROFILE_2)),
      0, 1);

  main_layout->addWidget(CreateGroupBox(tr("Wii Remote %1").arg(3),
                             HotkeyManagerEmu::GetHotkeyGroup(HKGP_CONTROLLER_PROFILE_3)),
      1, 0);

  main_layout->addWidget(CreateGroupBox(tr("Wii Remote %1").arg(4),
