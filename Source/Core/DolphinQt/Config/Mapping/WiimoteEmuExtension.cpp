...
void WiimoteEmuExtension::CreateClassicLayout()
{
  ...
  layout->addWidget(CreateGroupBox(tr("D-Pad"),
      ...
      1, 0);
  layout->addWidget(CreateGroupBox(tr("Left Stick"),
                        Wiimote::GetClassicGroup(GetPort(), WiimoteEmu::ClassicGroup::LeftStick)),
      0, 1, -1, 1);
  layout->addWidget(CreateGroupBox(tr("Right Stick"),
                        Wiimote::GetClassicGroup(GetPort(), WiimoteEmu::ClassicGroup::RightStick)),
      0, 2, -1, 1);
  layout->addWidget(CreateGroupBox(tr("Triggers"),
...
void WiimoteEmuExtension::CreateNunchukLayout()
{
  ...
  layout->addWidget(CreateGroupBox(tr("Stick"),
...
void WiimoteEmuExtension::CreateTurntableLayout()
{
  ...
  layout->addWidget(CreateGroupBox(tr("Buttons"),
      ...
      0, 1);
  layout->addWidget(CreateGroupBox(tr("Effect"), Wiimote::GetTurntableGroup(GetPort(),
                                                     WiimoteEmu::TurntableGroup::EffectDial)),
      1, 1, -1, 1);
  ...
  layout->addWidget(CreateGroupBox(
      ...
      1, 2);
  layout->addWidget(CreateGroupBox(tr("Crossfade"), Wiimote::GetTurntableGroup(GetPort(),
                                                        WiimoteEmu::TurntableGroup::Crossfade)),
      2, 2);
...
void WiimoteEmuExtension::CreateUDrawTabletLayout()
{
  ...
  hbox->addWidget(CreateGroupBox(tr("Buttons"),
...
void WiimoteEmuExtension::CreateDrawsomeTabletLayout()
{
  ...
  hbox->addWidget(CreateGroupBox(tr("Stylus"),
      Wiimote::GetDrawsomeTabletGroup(GetPort(), WiimoteEmu::DrawsomeTabletGroup::Stylus)));

  hbox->addWidget(CreateGroupBox(tr("Touch"),
