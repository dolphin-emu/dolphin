    ...
    : TASInputWindow(parent), m_controller_id(controller_id)
{
  ...
  m_main_stick_box =
      CreateStickInputs(tr("Main Stick"), GCPad::MAIN_STICK_GROUP, &m_overrider,
                        m_x_main_stick_value, m_y_main_stick_value, 255, 255, Qt::Key_F, Qt::Key_G);
  m_c_stick_box =
