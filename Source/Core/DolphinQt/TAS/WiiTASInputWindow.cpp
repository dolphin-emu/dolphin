...
WiiTASInputWindow::WiiTASInputWindow(QWidget* parent, int num) : TASInputWindow(parent), m_num(num)
{
  ...
  m_ir_x_value = CreateSliderValuePair(
      ...
      &m_wiimote_overrider, x_layout, ir_x_center, ir_x_center, ir_max_x,
  ...
  m_ir_y_value = CreateSliderValuePair(
      ...
      &m_wiimote_overrider, y_layout, ir_y_center, ir_y_center, ir_max_y,
  ...
  m_nunchuk_stick_box = CreateStickInputs(tr("Nunchuk Stick"), WiimoteEmu::Nunchuk::STICK_GROUP,
                                          &m_nunchuk_overrider, m_nunchuk_stick_x_value,
                                          m_nunchuk_stick_y_value, 255, 255, Qt::Key_X, Qt::Key_Y);

  m_classic_left_stick_box = CreateStickInputs(
      tr("Left Stick"), WiimoteEmu::Classic::LEFT_STICK_GROUP, &m_classic_overrider,
      m_classic_left_stick_x_value, m_classic_left_stick_y_value, 63, 63, Qt::Key_F, Qt::Key_G);

  m_classic_right_stick_box = CreateStickInputs(
      tr("Right Stick"), WiimoteEmu::Classic::RIGHT_STICK_GROUP, &m_classic_overrider,
      m_classic_right_stick_x_value, m_classic_right_stick_y_value, 31, 31, Qt::Key_Q, Qt::Key_W);
  ...
  auto* remote_orientation_x_layout =
      ...
      CreateSliderValuePairLayout(tr("X"), WiimoteEmu::Wiimote::ACCELEROMETER_GROUP,
                                  ...
                                  ACCEL_ZERO_G, ACCEL_MAX, Qt::Key_Q, m_remote_orientation_box,
                                  ACCEL_SCALE);
  auto* remote_orientation_y_layout =
      ...
      CreateSliderValuePairLayout(tr("Y"), WiimoteEmu::Wiimote::ACCELEROMETER_GROUP,
                                  ...
                                  ACCEL_ZERO_G, ACCEL_MAX, Qt::Key_W, m_remote_orientation_box,
                                  ACCEL_SCALE);
  auto* remote_orientation_z_layout =
      ...
      CreateSliderValuePairLayout(tr("Z"), WiimoteEmu::Wiimote::ACCELEROMETER_GROUP,
                                  ...
                                  ACCEL_ONE_G, ACCEL_MAX, Qt::Key_E, m_remote_orientation_box,
                                  ACCEL_SCALE);
  ...
  auto* nunchuk_orientation_x_layout =
      ...
      CreateSliderValuePairLayout(tr("X"), WiimoteEmu::Nunchuk::ACCELEROMETER_GROUP,
                                  ...
                                  ACCEL_ZERO_G, ACCEL_MAX, Qt::Key_I, m_nunchuk_orientation_box);
  auto* nunchuk_orientation_y_layout =
      ...
      CreateSliderValuePairLayout(tr("Y"), WiimoteEmu::Nunchuk::ACCELEROMETER_GROUP,
                                  ...
                                  ACCEL_ZERO_G, ACCEL_MAX, Qt::Key_O, m_nunchuk_orientation_box);
  auto* nunchuk_orientation_z_layout =
      ...
      CreateSliderValuePairLayout(tr("Z"), WiimoteEmu::Nunchuk::ACCELEROMETER_GROUP,
                                  ...
                                  ACCEL_ONE_G, ACCEL_MAX, Qt::Key_P, m_nunchuk_orientation_box);
  ...
  auto* l_trigger_layout = CreateSliderValuePairLayout(
      ...
      &m_classic_overrider, m_left_trigger_value, 0, 0, 31, Qt::Key_N, m_triggers_box);
  auto* r_trigger_layout = CreateSliderValuePairLayout(
      tr("Right"), WiimoteEmu::Classic::TRIGGERS_GROUP, WiimoteEmu::Classic::R_ANALOG,
      &m_classic_overrider, m_right_trigger_value, 0, 0, 31, Qt::Key_M, m_triggers_box);
