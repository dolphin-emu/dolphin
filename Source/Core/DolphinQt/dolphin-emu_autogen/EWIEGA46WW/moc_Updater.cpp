...
#include <memory>
#include "../../../../../../Source/Core/DolphinQt/Updater.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Updater_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Updater_t qt_meta_stringdata_Updater = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Updater[] = {
...
Q_CONSTINIT const QMetaObject Updater::staticMetaObject = { {
    ...
    qt_meta_stringdata_Updater.offsetsAndSizes,
...
void *Updater::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "AutoUpdateChecker"))
        return static_cast< AutoUpdateChecker*>(this);
