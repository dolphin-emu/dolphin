...
#include <memory>
#include "../../../../../../Source/Core/DolphinQt/Config/InfoWidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_InfoWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_InfoWidget_t qt_meta_stringdata_InfoWidget = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_InfoWidget[] = {
...
Q_CONSTINIT const QMetaObject InfoWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_InfoWidget.offsetsAndSizes,
    qt_meta_data_InfoWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_InfoWidget_t,
        // Q_OBJECT / Q_GADGET
