...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_LogConfigWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_LogConfigWidget_t qt_meta_stringdata_LogConfigWidget = {
    {
        QT_MOC_LITERAL(0, 15)   // "LogConfigWidget"
    },
    "LogConfigWidget"
};
...
Q_CONSTINIT static const uint qt_meta_data_LogConfigWidget[] = {
...
Q_CONSTINIT const QMetaObject LogConfigWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QDockWidget::staticMetaObject>(),
    qt_meta_stringdata_LogConfigWidget.offsetsAndSizes,
    qt_meta_data_LogConfigWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_LogConfigWidget_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<LogConfigWidget, std::true_type>
    >,
    nullptr
} };
