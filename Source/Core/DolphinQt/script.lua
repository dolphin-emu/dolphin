...
io.write("Wrote to consecutive addresses the value 0X01, 0X02, 0X03, 0X04, 0X05, 0X06, 0X07, and 0X08. Then read the base address into a ByteWrapper...\n")
io.write("The above ByteWrapper as a u64 is " )
io.write(byteWrap:get_value("u64"))
io.write("\nThe above ByteWrapper as a u32 is ")
io.write(byteWrap:get_value("u32"))
io.write("\nThe above ByteWrapper as a u16 is ")
io.write(byteWrap:get_value("u16"))
io.write("\nThe above ByteWrapper as a u8 is ")
io.write(byteWrap:get_value("u8"))
io.write("\n\n\n")

local b = ByteWrapper(5000000001)
io.write(5000000001)
io.write(" was written directly into a ByteWrapper. Now listing the value after converting it to a u64, a u32, a u16, and a u8 respectively:\n")
io.write(b:get_value("u64"))
io.write("\n")
io.write(b:get_value("u32"))
io.write("\n")
io.write(b:get_value("u16"))
io.write("\n")
io.write(b:get_value("u8"))
io.write("\n")
io.flush()
io.close()
