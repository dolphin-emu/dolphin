...
private:
  ...
  void LoadDefaultSymbolMap();
  void LoadOtherSymbolMap();
  void LoadBadSymbolMap();
  void SaveDefaultSymbolMap();
  void SaveOtherSymbolMap();
  void SaveDefaultCodeMap();
  void SaveOtherCodeMap();
  void TrySaveCodeMap(const QString& path);
  void TryLoadMapFile(const QString& path, const bool bad = false);
