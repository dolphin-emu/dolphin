...
struct JitBlock {
  ...
  // TODO (mb2): ticStart and ticStop -> "local var" mean "in block" ... low
  // priority ;)
...
class JitBaseBlockCache {
  ...
  std::map<std::pair<u32, u32>, u32>
      block_map; // (end_addr, start_addr) -> number
...
public:
  ...
  // Fast way to get a block. Only works on the first ppc instruction of a
  // block.
