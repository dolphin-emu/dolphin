...
void Jit64::cmpXX(UGeckoInstruction inst)
{
  ...
  case 11:
    signedCompare = true;
    comparand = RCOpArg::Imm32(static_cast<u32>(static_cast<s32>((s16)inst.UIMM)));
    break;
...
void Jit64::extsXx(UGeckoInstruction inst)
{
  ...
  if (gpr.IsImm(s))
  {
    gpr.SetImmediate32(a, static_cast<u32>((s32)(size == 16 ? static_cast<s16>(gpr.Imm32(s)) : static_cast<s8>(gpr.Imm32(s)))));
  }
  else
  {
    RCOpArg Rs = gpr.Use(s, RCMode::Read);
...
void Jit64::mulhwXx(UGeckoInstruction inst)
{
  ...
  {
    if (sign)
      gpr.SetImmediate32(d, static_cast<u32>(static_cast<u64>(((s64)gpr.SImm32(a) * (s64)gpr.SImm32(b))) >> 32));
    else
      gpr.SetImmediate32(d, static_cast<u32>((static_cast<u64>(gpr.Imm32(a)) * static_cast<u64>(gpr.Imm32(b))) >> 32));
  }
  else if (sign)
  {
    RCOpArg Ra = gpr.Use(a, RCMode::Read);
