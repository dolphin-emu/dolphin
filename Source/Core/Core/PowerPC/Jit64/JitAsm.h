...
// In Dolphin, we don't use inline assembly. Instead, we generate all
// machine-near
// code at runtime. In the case of fixed code like this, after writing it, we
// write
...
// There aren't really any disadvantages other than having to maintain a x86
// emitter,
// which we have to do anyway :)
//
// To add a new asm routine, just add another const here, and add the code to
// Generate.
