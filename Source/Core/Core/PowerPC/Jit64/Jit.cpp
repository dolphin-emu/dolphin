...
void Jit64::UnexpectedInstructionForm()
{
	...
	_assert_msg_(DYNA_REC, 0, "Unexpected instruction form: PC = %08x  %s", js.compilerPC, ppc_inst.c_str());
...
BitSet8 Jit64::ComputeStaticGQRs(const PPCAnalyst::CodeBlock& code) const
{
	return code.m_gqr_used & ~code.m_gqr_modified;
}
