...
void Jit64::fp_arith(UGeckoInstruction inst)
{
	...
	if (single &&
	    fpr.IsLazySingle(a) &&
	    fpr.IsLazySingle(arg2) &&
	    cpu_info.bAVX &&
	    !SConfig::GetInstance().bAccurateNaNs &&
	    !(SConfig::GetInstance().bFPRF && js.op->wantsFPRF))
	{
		...
		switch (inst.SUBOP5)
		{
			case 18: VDIVSS(dest, opa, fpr.R_lazy_single(arg2)); break;
			case 20: VSUBSS(dest, opa, fpr.R_lazy_single(arg2)); break;
			case 21: VADDSS(dest, opa, fpr.R_lazy_single(arg2)); break;
			case 25: VMULSS(dest, opa, fpr.R_lazy_single(arg2)); break;
			default:
