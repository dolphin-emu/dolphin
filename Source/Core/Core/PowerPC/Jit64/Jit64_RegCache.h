...
protected:
	...
	virtual const BitSet32& DisallowScratch() const { return DISALLOW_SCRATCH_FPU; };
...
protected:
	...
	virtual const BitSet32& DisallowScratch() const { return DISALLOW_SCRATCH_GPR; };
	virtual void LoadRegister(X64Reg newLoc, const OpArg& location)
	{
		// Is carry precious?
