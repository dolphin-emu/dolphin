...
const float m_dequantizeTable[] = {
    ...
    1.0 / (1ULL << 30), 1.0 / (1ULL << 31), (1ULL << 32),
    (1ULL << 31),       (1ULL << 30),       (1ULL << 29),
    (1ULL << 28),       (1ULL << 27),       (1ULL << 26),
    (1ULL << 25),       (1ULL << 24),       (1ULL << 23),
    (1ULL << 22),       (1ULL << 21),       (1ULL << 20),
    (1ULL << 19),       (1ULL << 18),       (1ULL << 17),
    (1ULL << 16),       (1ULL << 15),       (1ULL << 14),
    (1ULL << 13),       (1ULL << 12),       (1ULL << 11),
    (1ULL << 10),       (1ULL << 9),        (1ULL << 8),
    (1ULL << 7),        (1ULL << 6),        (1ULL << 5),
    (1ULL << 4),        (1ULL << 3),        (1ULL << 2),
    (1ULL << 1),
};
...
const float m_quantizeTable[] = {
    ...
    (1ULL << 27),       (1ULL << 28),       (1ULL << 29),
    (1ULL << 30),       (1ULL << 31),       1.0 / (1ULL << 32),
    1.0 / (1ULL << 31), 1.0 / (1ULL << 30), 1.0 / (1ULL << 29),
    1.0 / (1ULL << 28), 1.0 / (1ULL << 27), 1.0 / (1ULL << 26),
    1.0 / (1ULL << 25), 1.0 / (1ULL << 24), 1.0 / (1ULL << 23),
    1.0 / (1ULL << 22), 1.0 / (1ULL << 21), 1.0 / (1ULL << 20),
    1.0 / (1ULL << 19), 1.0 / (1ULL << 18), 1.0 / (1ULL << 17),
    1.0 / (1ULL << 16), 1.0 / (1ULL << 15), 1.0 / (1ULL << 14),
    1.0 / (1ULL << 13), 1.0 / (1ULL << 12), 1.0 / (1ULL << 11),
    1.0 / (1ULL << 10), 1.0 / (1ULL << 9),  1.0 / (1ULL << 8),
    1.0 / (1ULL << 7),  1.0 / (1ULL << 6),  1.0 / (1ULL << 5),
    1.0 / (1ULL << 4),  1.0 / (1ULL << 3),  1.0 / (1ULL << 2),
    1.0 / (1ULL << 1),
};
...
template <> u8 ReadUnpaired<u8>(u32 addr) { return PowerPC::Read_U8(addr); }

template <> u16 ReadUnpaired<u16>(u32 addr) { return PowerPC::Read_U16(addr); }

template <> u32 ReadUnpaired<u32>(u32 addr) { return PowerPC::Read_U32(addr); }
...
template <typename T>
void QuantizeAndStore(double ps0, double ps1, u32 addr, u32 instW,
                      u32 stScale) {
...
void Interpreter::Helper_Dequantize(u32 addr, u32 instI, u32 instRD,
                                    u32 instW) {
...
void Interpreter::psq_l(UGeckoInstruction _inst) {
  const u32 EA =
      _inst.RA ? (rGPR[_inst.RA] + _inst.SIMM_12) : (u32)_inst.SIMM_12;
