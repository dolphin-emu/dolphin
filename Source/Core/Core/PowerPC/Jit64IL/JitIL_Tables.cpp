...
static GekkoOPTemplate primarytable[] = {
    ...
    {19,
     &JitIL::DynaRunTable19}, //"RunTable19", OPTYPE_SUBTABLE | (19<<24), 0}},
    {31,
     &JitIL::DynaRunTable31}, //"RunTable31", OPTYPE_SUBTABLE | (31<<24), 0}},
    {59,
     &JitIL::DynaRunTable59}, //"RunTable59", OPTYPE_SUBTABLE | (59<<24), 0}},
    {63,
     &JitIL::DynaRunTable63}, //"RunTable63", OPTYPE_SUBTABLE | (63<<24), 0}},
    ...
    {7, &JitIL::mulli},    //"mulli",    OPTYPE_INTEGER, FL_OUT_D | FL_IN_A |
                           // FL_RC_BIT, 2}},
    {8, &JitIL::subfic},   //"subfic",   OPTYPE_INTEGER, FL_OUT_D | FL_IN_A |
                           // FL_SET_CA}},
    {10, &JitIL::cmpXX},   //"cmpli",    OPTYPE_INTEGER, FL_IN_A | FL_SET_CRn}},
    {11, &JitIL::cmpXX},   //"cmpi",     OPTYPE_INTEGER, FL_IN_A | FL_SET_CRn}},
    {12, &JitIL::reg_imm}, //"addic",    OPTYPE_INTEGER, FL_OUT_D | FL_IN_A |
                           // FL_SET_CA}},
    {13, &JitIL::reg_imm}, //"addic_rc", OPTYPE_INTEGER, FL_OUT_D | FL_IN_A |
                           // FL_SET_CR0}},
    {14, &JitIL::reg_imm}, //"addi",     OPTYPE_INTEGER, FL_OUT_D | FL_IN_A0}},
    {15, &JitIL::reg_imm}, //"addis",    OPTYPE_INTEGER, FL_OUT_D | FL_IN_A0}},

    {20, &JitIL::rlwimix}, //"rlwimix",  OPTYPE_INTEGER, FL_OUT_A | FL_IN_A |
                           // FL_IN_S | FL_RC_BIT}},
    {21, &JitIL::rlwinmx}, //"rlwinmx",  OPTYPE_INTEGER, FL_OUT_A | FL_IN_S |
                           // FL_RC_BIT}},
    {23, &JitIL::rlwnmx},  //"rlwnmx",   OPTYPE_INTEGER, FL_OUT_A | FL_IN_S |
                           // FL_IN_B | FL_RC_BIT}},
    ...
    {28, &JitIL::reg_imm}, //"andi_rc",  OPTYPE_INTEGER, FL_OUT_A | FL_IN_S |
                           // FL_SET_CR0}},
    {29, &JitIL::reg_imm}, //"andis_rc", OPTYPE_INTEGER, FL_OUT_A | FL_IN_S |
                           // FL_SET_CR0}},
...
static GekkoOPTemplate table4[] = {
    ...
    {32,
     &JitIL::FallBackToInterpreter}, //"ps_cmpo0",   OPTYPE_PS, FL_SET_CRn}},
    {40, &JitIL::FallBackToInterpreter}, //"ps_neg",     OPTYPE_PS, FL_RC_BIT}},
    {136,
     &JitIL::FallBackToInterpreter}, //"ps_nabs",    OPTYPE_PS, FL_RC_BIT}},
    {264,
     &JitIL::FallBackToInterpreter},     //"ps_abs",     OPTYPE_PS, FL_RC_BIT}},
...
static GekkoOPTemplate table19[] = {
    ...
    {50, &JitIL::rfi}, //"rfi",    OPTYPE_SYSTEM, FL_ENDBLOCK |
                       // FL_CHECKEXCEPTIONS, 1}},
};

static GekkoOPTemplate table31[] = {
    {266, &JitIL::addx}, //"addx",    OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                         // FL_RC_BIT}},
    {778, &JitIL::addx}, //"addox",   OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                         // FL_RC_BIT}},
    {10, &JitIL::FallBackToInterpreter}, //"addcx",   OPTYPE_INTEGER, FL_OUT_D |
                                         // FL_IN_AB | FL_SET_CA | FL_RC_BIT}},
    {522, &JitIL::FallBackToInterpreter}, //"addcox",  OPTYPE_INTEGER, FL_OUT_D
                                          //| FL_IN_AB | FL_SET_CA |
                                          // FL_RC_BIT}},
    {138, &JitIL::addex}, //"addex",   OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                          // FL_READ_CA | FL_SET_CA | FL_RC_BIT}},
    {650, &JitIL::addex}, //"addeox",  OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                          // FL_READ_CA | FL_SET_CA | FL_RC_BIT}},
    {234, &JitIL::FallBackToInterpreter}, //"addmex",  OPTYPE_INTEGER, FL_OUT_D
                                          //| FL_IN_AB |
    // FL_READ_CA | FL_SET_CA | FL_RC_BIT}},
    {746, &JitIL::FallBackToInterpreter}, //"addmeox"
    {202, &JitIL::addzex}, //"addzex",  OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                           // FL_READ_CA | FL_SET_CA | FL_RC_BIT}},
    {714, &JitIL::addzex}, //"addzeox"
    {491, &JitIL::FallBackToInterpreter},  //"divwx",   OPTYPE_INTEGER, FL_OUT_D
                                           //| FL_IN_AB |
                                           // FL_RC_BIT, 39}},
    {1003, &JitIL::FallBackToInterpreter}, //"divwox",  OPTYPE_INTEGER, FL_OUT_D
                                           //| FL_IN_AB |
                                           // FL_RC_BIT, 39}},
    {459, &JitIL::divwux}, //"divwux",  OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                           // FL_RC_BIT, 39}},
    {971, &JitIL::divwux}, //"divwuox", OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                           // FL_RC_BIT, 39}},
    {75, &JitIL::FallBackToInterpreter}, //"mulhwx",  OPTYPE_INTEGER, FL_OUT_D |
                                         // FL_IN_AB | FL_RC_BIT, 4}},
    {11, &JitIL::mulhwux}, //"mulhwux", OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                           // FL_RC_BIT, 4}},
    {235, &JitIL::mullwx}, //"mullwx",  OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                           // FL_RC_BIT, 4}},
    {747, &JitIL::mullwx}, //"mullwox", OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                           // FL_RC_BIT, 4}},
    {104, &JitIL::negx},   //"negx",    OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                           // FL_RC_BIT}},
    {616, &JitIL::negx},   //"negox"
    {40, &JitIL::subfx},   //"subfx",   OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                           // FL_RC_BIT}},
    {552, &JitIL::subfx},  //"subfox",  OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                           // FL_RC_BIT}},
    {8, &JitIL::subfcx},   //"subfcx",  OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                           // FL_SET_CA | FL_RC_BIT}},
    {520, &JitIL::subfcx}, //"subfcox", OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                           // FL_SET_CA | FL_RC_BIT}},
    {136, &JitIL::subfex}, //"subfex",  OPTYPE_INTEGER, FL_OUT_D | FL_IN_AB |
                           // FL_READ_CA | FL_SET_CA | FL_RC_BIT}},
    {648, &JitIL::subfex}, //"subfeox"
    {232, &JitIL::FallBackToInterpreter}, //"subfmex", OPTYPE_INTEGER, FL_OUT_D
                                          //| FL_IN_AB |
    // FL_READ_CA | FL_SET_CA | FL_RC_BIT}},
    {744, &JitIL::FallBackToInterpreter}, //"subfmeox"
    {200, &JitIL::FallBackToInterpreter}, //"subfzex", OPTYPE_INTEGER, FL_OUT_D
                                          //| FL_IN_AB |
    // FL_READ_CA | FL_SET_CA | FL_RC_BIT}},
    {712, &JitIL::FallBackToInterpreter}, //"subfzeox"

    {28, &JitIL::boolX},   //"andx",   OPTYPE_INTEGER, FL_OUT_A | FL_IN_SB |
                           // FL_RC_BIT}},
    {60, &JitIL::boolX},   //"andcx",  OPTYPE_INTEGER, FL_OUT_A | FL_IN_SB |
                           // FL_RC_BIT}},
    {444, &JitIL::boolX},  //"orx",    OPTYPE_INTEGER, FL_OUT_A | FL_IN_SB |
                           // FL_RC_BIT}},
    {124, &JitIL::boolX},  //"norx",   OPTYPE_INTEGER, FL_OUT_A | FL_IN_SB |
                           // FL_RC_BIT}},
    {316, &JitIL::boolX},  //"xorx",   OPTYPE_INTEGER, FL_OUT_A | FL_IN_SB |
                           // FL_RC_BIT}},
    {412, &JitIL::boolX},  //"orcx",   OPTYPE_INTEGER, FL_OUT_A | FL_IN_SB |
                           // FL_RC_BIT}},
    {476, &JitIL::boolX},  //"nandx",  OPTYPE_INTEGER, FL_OUT_A | FL_IN_SB |
                           // FL_RC_BIT}},
    {284, &JitIL::boolX},  //"eqvx",   OPTYPE_INTEGER, FL_OUT_A | FL_IN_SB |
                           // FL_RC_BIT}},
    {0, &JitIL::cmpXX},    //"cmp",    OPTYPE_INTEGER, FL_IN_AB | FL_SET_CRn}},
    {32, &JitIL::cmpXX},   //"cmpl",   OPTYPE_INTEGER, FL_IN_AB | FL_SET_CRn}},
    {26, &JitIL::cntlzwx}, //"cntlzwx",OPTYPE_INTEGER, FL_OUT_A | FL_IN_S |
                           // FL_RC_BIT}},
    {922, &JitIL::extshx}, //"extshx", OPTYPE_INTEGER, FL_OUT_A | FL_IN_S |
                           // FL_RC_BIT}},
    {954, &JitIL::extsbx}, //"extsbx", OPTYPE_INTEGER, FL_OUT_A | FL_IN_S |
                           // FL_RC_BIT}},
    {536, &JitIL::srwx},   //"srwx",   OPTYPE_INTEGER, FL_OUT_A | FL_IN_B |
                           // FL_IN_S | FL_RC_BIT}},
    {792, &JitIL::srawx},  //"srawx",  OPTYPE_INTEGER, FL_OUT_A | FL_IN_B |
                           // FL_IN_S | FL_RC_BIT}},
    {824, &JitIL::srawix}, //"srawix", OPTYPE_INTEGER, FL_OUT_A | FL_IN_B |
                           // FL_IN_S | FL_RC_BIT}},
    {24, &JitIL::slwx}, //"slwx",   OPTYPE_INTEGER, FL_OUT_A | FL_IN_B | FL_IN_S
                        //| FL_RC_BIT}},
    ...
    {55, &JitIL::lXzx}, //"lwzux", OPTYPE_LOAD, FL_OUT_D | FL_OUT_A | FL_IN_A |
                        // FL_IN_B}},

    // load halfword
    {279,
     &JitIL::lXzx}, //"lhzx",  OPTYPE_LOAD, FL_OUT_D | FL_IN_A0 | FL_IN_B}},
    {311, &JitIL::lXzx}, //"lhzux", OPTYPE_LOAD, FL_OUT_D | FL_OUT_A | FL_IN_A |
                         // FL_IN_B}},

    // load halfword signextend
    {343,
     &JitIL::lhax}, //"lhax",  OPTYPE_LOAD, FL_OUT_D | FL_IN_A0 | FL_IN_B}},
    {375, &JitIL::lhaux}, //"lhaux", OPTYPE_LOAD, FL_OUT_D | FL_OUT_A | FL_IN_A
                          //| FL_IN_B}},

    // load byte
    {87, &JitIL::lXzx}, //"lbzx",  OPTYPE_LOAD, FL_OUT_D | FL_IN_A0 | FL_IN_B}},
    {119, &JitIL::lXzx}, //"lbzux", OPTYPE_LOAD, FL_OUT_D | FL_OUT_A | FL_IN_A |
                         // FL_IN_B}},

    // load byte reverse
    {534, &JitIL::FallBackToInterpreter}, //"lwbrx", OPTYPE_LOAD, FL_OUT_D |
                                          // FL_IN_A0 | FL_IN_B}},
    {790, &JitIL::FallBackToInterpreter}, //"lhbrx", OPTYPE_LOAD, FL_OUT_D |
                                          // FL_IN_A0 | FL_IN_B}},

    // Conditional load/store (Wii SMP)
    {150, &JitIL::FallBackToInterpreter}, //"stwcxd", OPTYPE_STORE, FL_EVIL |
                                          // FL_SET_CR0}},
    {20, &JitIL::FallBackToInterpreter},  //"lwarx",  OPTYPE_LOAD, FL_EVIL |
    // FL_OUT_D | FL_IN_A0B | FL_SET_CR0}},

    // load string (interpret these)
    {533, &JitIL::FallBackToInterpreter}, //"lswx",  OPTYPE_LOAD, FL_EVIL |
                                          // FL_IN_A | FL_OUT_D}},
    {597, &JitIL::FallBackToInterpreter}, //"lswi",  OPTYPE_LOAD, FL_EVIL |
                                          // FL_IN_AB | FL_OUT_D}},

    // store word
    {151, &JitIL::stXx}, //"stwx",   OPTYPE_STORE, FL_IN_A0 | FL_IN_B}},
    {183,
     &JitIL::stXx}, //"stwux",  OPTYPE_STORE, FL_OUT_A | FL_IN_A | FL_IN_B}},

    // store halfword
    {407, &JitIL::stXx}, //"sthx",   OPTYPE_STORE, FL_IN_A0 | FL_IN_B}},
    {439,
     &JitIL::stXx}, //"sthux",  OPTYPE_STORE, FL_OUT_A | FL_IN_A | FL_IN_B}},

    // store byte
    {215, &JitIL::stXx}, //"stbx",   OPTYPE_STORE, FL_IN_A0 | FL_IN_B}},
    {247,
     &JitIL::stXx}, //"stbux",  OPTYPE_STORE, FL_OUT_A | FL_IN_A | FL_IN_B}},

    // store bytereverse
    {662, &JitIL::FallBackToInterpreter}, //"stwbrx", OPTYPE_STORE, FL_IN_A0 |
                                          // FL_IN_B}},
    {918, &JitIL::FallBackToInterpreter}, //"sthbrx", OPTYPE_STORE, FL_IN_A |
                                          // FL_IN_B}},
    ...
    {567, &JitIL::FallBackToInterpreter}, //"lfsux", OPTYPE_LOADFP, FL_IN_A |
                                          // FL_IN_B}},
    {599, &JitIL::FallBackToInterpreter}, //"lfdx",  OPTYPE_LOADFP, FL_IN_A0 |
                                          // FL_IN_B}},
    {631, &JitIL::FallBackToInterpreter}, //"lfdux", OPTYPE_LOADFP, FL_IN_A |
                                          // FL_IN_B}},

    {663, &JitIL::stfsx}, //"stfsx",  OPTYPE_STOREFP, FL_IN_A0 | FL_IN_B}},
    {695, &JitIL::FallBackToInterpreter}, //"stfsux", OPTYPE_STOREFP, FL_IN_A |
                                          // FL_IN_B}},
    {727, &JitIL::FallBackToInterpreter}, //"stfdx",  OPTYPE_STOREFP, FL_IN_A0 |
                                          // FL_IN_B}},
    {759, &JitIL::FallBackToInterpreter}, //"stfdux", OPTYPE_STOREFP, FL_IN_A |
                                          // FL_IN_B}},
    {983, &JitIL::FallBackToInterpreter}, //"stfiwx", OPTYPE_STOREFP, FL_IN_A0 |
                                          // FL_IN_B}},
    ...
    {595,
     &JitIL::FallBackToInterpreter}, //"mfsr",   OPTYPE_SYSTEM, FL_OUT_D, 2}},
    {659,
     &JitIL::FallBackToInterpreter}, //"mfsrin", OPTYPE_SYSTEM, FL_OUT_D, 2}},
    ...
    {310,
     &JitIL::FallBackToInterpreter}, //"eciwx",   OPTYPE_INTEGER, FL_RC_BIT}},
    {438,
     &JitIL::FallBackToInterpreter}, //"ecowx",   OPTYPE_INTEGER, FL_RC_BIT}},
...
static GekkoOPTemplate table59[] = {
    {18, &JitIL::FallBackToInterpreter}, //{"fdivsx",  OPTYPE_FPU, FL_RC_BIT_F,
                                         // 16}},
    {20, &JitIL::fp_arith_s}, //"fsubsx",   OPTYPE_FPU, FL_RC_BIT_F}},
    {21, &JitIL::fp_arith_s}, //"faddsx",   OPTYPE_FPU, FL_RC_BIT_F}},
    {24,
     &JitIL::FallBackToInterpreter}, //"fresx",    OPTYPE_FPU, FL_RC_BIT_F}},
...
static GekkoOPTemplate table63_2[] = {
    {18, &JitIL::FallBackToInterpreter}, //"fdivx",    OPTYPE_FPU, FL_RC_BIT_F,
                                         // 30}},
    {20,
     &JitIL::FallBackToInterpreter}, //"fsubx",    OPTYPE_FPU, FL_RC_BIT_F}},
    {21,
     &JitIL::FallBackToInterpreter}, //"faddx",    OPTYPE_FPU, FL_RC_BIT_F}},
    {23,
     &JitIL::FallBackToInterpreter}, //"fselx",    OPTYPE_FPU, FL_RC_BIT_F}},
    {25, &JitIL::fp_arith_s},        //"fmulx",    OPTYPE_FPU, FL_RC_BIT_F}},
    {26,
     &JitIL::FallBackToInterpreter}, //"frsqrtex", OPTYPE_FPU, FL_RC_BIT_F}},
...
void CompileInstruction(PPCAnalyst::CodeOp &op) {
  ...
  if (info) {
    ...
    PanicAlert(
        "Tried to compile illegal (or unknown) instruction %08x, at %08x",
        op.inst.hex, jit->js.compilerPC);
  }
}
