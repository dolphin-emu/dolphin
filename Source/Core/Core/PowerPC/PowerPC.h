...
// CPU Thread run state. Needed for inner fast run loops in CPU Backends to
// detect state changes.
using CPUState = CPU::State;
constexpr CPUState CPU_RUNNING   = CPU::CPU_RUNNING;
constexpr CPUState CPU_STEPPING  = CPU::CPU_STEPPING;
constexpr CPUState CPU_POWERDOWN = CPU::CPU_POWERDOWN;
using CPU::GetState;
using CPU::GetStatePtr;
