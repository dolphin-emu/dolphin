...
void InitTables() {
  ...
  for (int i = 0; i < (int)(sizeof(primarytable) / sizeof(GekkoOPTemplate));
       i++) {
  ...
  for (int i = 0; i < 32; i++) {
    int fill = i << 5;
    for (int j = 0; j < (int)(sizeof(table4_2) / sizeof(GekkoOPTemplate));
         j++) {
  ...
  for (int i = 0; i < 16; i++) {
    int fill = i << 6;
    for (int j = 0; j < (int)(sizeof(table4_3) / sizeof(GekkoOPTemplate));
         j++) {
  ...
  for (int i = 0; i < 32; i++) {
    int fill = i << 5;
    for (int j = 0; j < (int)(sizeof(table63_2) / sizeof(GekkoOPTemplate));
         j++) {
