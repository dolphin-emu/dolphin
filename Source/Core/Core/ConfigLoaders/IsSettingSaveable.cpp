...
bool IsSettingSaveable(const Config::ConfigLocation& config_location)
{
  ...
  const static std::vector<Config::ConfigLocation> s_setting_saveable{
      ...
      Config::GFX_CUSTOM_TEXTURES.location, Config::GFX_CONVERT_CUSTOM_TEXTURES.location,
      Config::GFX_PREFETCH_CUSTOM_TEXTURES.location, Config::GFX_DUMP_EFB_TARGET.location,
