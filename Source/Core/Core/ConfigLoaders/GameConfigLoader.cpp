...
static const INIToLocationMap& GetINIToLocationMap()
{
  static const INIToLocationMap ini_to_location = {
      ...
      {{"Video_Settings", "HiresTextures"}, {Config::GFX_CUSTOM_TEXTURES.location}},
      {{"Video_Settings", "ConvertHiresTextures"}, {Config::GFX_CONVERT_CUSTOM_TEXTURES.location}},
      {{"Video_Settings", "CacheHiresTextures"}, {Config::GFX_PREFETCH_CUSTOM_TEXTURES.location}},
