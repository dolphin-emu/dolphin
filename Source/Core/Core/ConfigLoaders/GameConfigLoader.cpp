...
static std::map<std::pair<std::string, std::string>, ConfigLocation> ini_to_location = {
    ...
    {{"Video_Settings", "CustomTextures"}, {Config::System::GFX, "Settings", "CustomTextures"}},
    {{"Video_Settings", "ConvertCustomTextures"},
     {Config::System::GFX, "Settings", "ConvertCustomTextures"}},
    {{"Video_Settings", "CacheCustomTextures"},
     {Config::System::GFX, "Settings", "CacheCustomTextures"}},
