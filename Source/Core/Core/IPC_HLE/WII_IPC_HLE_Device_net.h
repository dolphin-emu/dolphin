...
public:
	...
	virtual u64 Open(u32 CommandAddress, u32 Mode) override;
	virtual u64 Close(u32 CommandAddress, bool Force) override;
	virtual u64 IOCtlV(u32 CommandAddress) override;
