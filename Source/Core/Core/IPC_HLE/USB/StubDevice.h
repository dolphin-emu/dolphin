...
class StubDevice final : public USBDevice
{
public:
  explicit StubDevice(u8 interface) : USBDevice(interface) {}
  ~StubDevice() = default;
  ...
  std::vector<u8> GetIOSDescriptors(IOSVersion, u8) override { return {}; }
};
