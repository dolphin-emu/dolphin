...
u64 CWII_IPC_HLE_Device_FileIO::Close(u32 _CommandAddress, bool _bForce)
{
...
u64 CWII_IPC_HLE_Device_FileIO::Open(u32 _CommandAddress, u32 _Mode)
{
	m_Mode = _Mode;
	u32 ReturnValue = 0;
...
u64 CWII_IPC_HLE_Device_FileIO::Seek(u32 _CommandAddress)
{
...
u64 CWII_IPC_HLE_Device_FileIO::Read(u32 _CommandAddress)
{
...
u64 CWII_IPC_HLE_Device_FileIO::Write(u32 _CommandAddress)
{
	u32 ReturnValue = FS_EACCESS;
...
u64 CWII_IPC_HLE_Device_FileIO::IOCtl(u32 _CommandAddress)
{
