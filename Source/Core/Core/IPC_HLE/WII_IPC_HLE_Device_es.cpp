...
u64 CWII_IPC_HLE_Device_es::Open(u32 _CommandAddress, u32 _Mode)
{
	OpenInternal();
...
u64 CWII_IPC_HLE_Device_es::Close(u32 _CommandAddress, bool _bForce)
{
...
u64 CWII_IPC_HLE_Device_es::IOCtlV(u32 _CommandAddress)
{
