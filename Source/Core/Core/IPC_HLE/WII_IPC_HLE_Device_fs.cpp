...
// ~1/1000th of a second is too short and causes hangs in Wii Party. Play it safe at 1/500th
static const u32 COMMAND_REPLY_DELAY = SystemTimers::GetTicksPerSecond() / 500;
...
u64 CWII_IPC_HLE_Device_fs::Open(u32 _CommandAddress, u32 _Mode)
{
	// clear tmp folder
	{
	...
	m_Active = true;
	return COMMAND_REPLY_DELAY;
}

u64 CWII_IPC_HLE_Device_fs::Close(u32 _CommandAddress, bool _bForce)
{
...
u64 CWII_IPC_HLE_Device_fs::IOCtlV(u32 _CommandAddress)
{
...
u64 CWII_IPC_HLE_Device_fs::IOCtl(u32 _CommandAddress)
{
