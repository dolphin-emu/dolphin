...
public:
  ...
  void StepOpcode(Common::TimeoutEvent* event = nullptr);
...
private:
  ...
  Common::TimeoutEvent* m_state_cpu_step_instruction_sync = nullptr;
  std::queue<std::function<void()>> m_pending_jobs;
  Common::TimeoutEvent m_time_played_finish_sync;
