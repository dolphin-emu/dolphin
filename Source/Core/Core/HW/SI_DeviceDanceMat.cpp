...
CSIDevice_DanceMat::CSIDevice_DanceMat(SIDevices device, int iDeviceNumber)
...
int CSIDevice_DanceMat::RunBuffer(u8* pBuffer, int iLength)
{
...
// SendCommand
void CSIDevice_DanceMat::SendCommand(u32 Cmd, u8 Poll)
{
