...
GCMemcardDirectory::GCMemcardDirectory(std::string directory, const ExpansionInterface::Slot slot,
...
s32 GCMemcardDirectory::DirectoryWrite(const u32 dest_address, const u32 length,
                                       const u8* src_address)
{
