...
double CalculateStopDistance(const double velocity, const double acceleration,
...
void EmulateSwing(MotionState* state, ControllerEmu::Force* swing_group, const float time_elapsed)
{
...
WiimoteCommon::AccelData ConvertAccelData(const Common::Vec3& accel, const u16 zero_g,
                                          const u16 one_g)
{
