...
{
void EncryptionKey::GenerateTables(
...
EncryptionKey::KeyData KeyGen1stParty::GenerateKeyData(
    const EncryptionKey::RandData& rand, const u32 idx) const
{
...
EncryptionKey::KeyData KeyGen3rdParty::GenerateKeyData(
    const EncryptionKey::RandData& rand, const u32 idx) const
{
  constexpr u8 ans_tbl[7][6] = {
...
EncryptionKey KeyGen1stParty::GenerateTables(
    const EncryptionKey::RandData& rand, const EncryptionKey::KeyData& key, u32 idx) const
{
...
EncryptionKey KeyGen3rdParty::GenerateTables(
    const EncryptionKey::RandData& rand, const EncryptionKey::KeyData& key, u32 idx) const
{
  EncryptionKey result;
...
EncryptionKey KeyGen1stParty::GenerateFallbackTables(
    const EncryptionKey::RandData& rand, const EncryptionKey::KeyData& key) const
{
...
EncryptionKey KeyGen3rdParty::GenerateFallbackTables(
    const EncryptionKey::RandData& rand, const EncryptionKey::KeyData& key) const
{
  // Reverse engineering did not produce exact tables, only the XOR effect of each.
  // This is the XOR difference between the tables.
