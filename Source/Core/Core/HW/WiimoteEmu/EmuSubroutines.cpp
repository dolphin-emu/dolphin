                                  ...
                                  bool desired_motion_plus)
{
  ...
  {
    INFO_LOG_FMT(WIIMOTE, "Detaching Motion Plus ({} in slot {})", GetName(), m_bt_device_index);
  ...
  if (desired_motion_plus && !m_is_motion_plus_attached)
  {
    ...
    {
      INFO_LOG_FMT(WIIMOTE, "Attaching Motion Plus ({} in slot {})", GetName(), m_bt_device_index);
  ...
  if (GetActiveExtensionNumber() != desired_extension_number)
  {
    ...
    if (GetActiveExtensionNumber() != ExtensionNumber::NONE)
    {
      INFO_LOG_FMT(WIIMOTE, "Detaching Extension ({} in slot {})", GetName(), m_bt_device_index);
    ...
    {
      INFO_LOG_FMT(WIIMOTE, "Switching to Extension {} ({} in slot {})",
                   Common::ToUnderlying(desired_extension_number), GetName(), m_bt_device_index);
