...
{
CSIDevice_GCAdapter::CSIDevice_GCAdapter(Core::System& system, const SIDevices device,
...
void CSIDevice_GCController::Rumble(const int pad_num, const ControlState strength,
