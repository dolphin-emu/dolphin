...
static constexpr u16 keys0_bitmasks[] = {KEYMASK_HOME,       KEYMASK_END, KEYMASK_PGUP, KEYMASK_PGDN,
...
static constexpr char* const named_keys0[] = {"HOME", "END", "PGUP", "PGDN", "SCR LK", "A", "B", "C",
                                              "D",    "E",   "F",    "G",    "H",      "I", "J", "K"};
static constexpr char* const named_keys1[] = {"L", "M", "N", "O", "P", "Q", "R", "S",
                                              "T", "U", "V", "W", "X", "Y", "Z", "1"};
static constexpr char* const named_keys2[] = {"2", "3", "4", "5",      "6", "7", "8",      "9",
                                              "0", "-", "`", "PRT SC", "'", "[", "EQUALS", "*"};
static constexpr char* const named_keys3[] = {"]",  ",",  ".",  "/",  "\\", "F1", "F2",  "F3",
                                              "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11"};
static constexpr char* const named_keys4[] = {
    "F12",     "ESC",     "INSERT", "DELETE", ";",     "BACKSPACE", "TAB",   "CAPS LOCK",
    "L SHIFT", "R SHIFT", "L CTRL", "R ALT",  "L WIN", "SPACE",     "R WIN", "MENU"};
static constexpr char* const named_keys5[] = {"LEFT", "DOWN", "UP", "RIGHT", "ENTER"};
...
ControllerEmu::ControlGroup* GCKeyboard::GetGroup(const KeyboardGroup group) const
{
  switch (group)
  {
