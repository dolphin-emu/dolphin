...
void CEXIMic::StreamStart()
{
  ...
  if (cubeb_stream_init(m_cubeb_ctx, &m_cubeb_stream, "Dolphin Emulated GameCube Microphone", NULL,
                        &params, NULL, NULL, std::max<u32>(buff_size_samples, minimum_latency),
                        data_callback, state_callback, this) != CUBEB_OK)
  {
