...
{
  // User overrides go in User/Load/Sounds/
  const std::string user_dir = File::GetUserPath(D_SOUNDS_IDX);

  // Default official assets go in Sys/Sounds/
  const std::string sys_dir = File::GetSysDirectory() + DIR_SEP + SOUNDS_DIR + DIR_SEP;
