...
void MovieConfigLayerLoader::Load(OnionConfig::Layer *config_layer) {
  OnionConfig::Section *core = config_layer->GetOrCreateSection(
      OnionConfig::System::SYSTEM_MAIN, "Core");
  OnionConfig::Section *display = config_layer->GetOrCreateSection(
      OnionConfig::System::SYSTEM_MAIN, "Display");
  OnionConfig::Section *video_settings = OnionConfig::GetOrCreateSection(
      OnionConfig::System::SYSTEM_GFX, "Settings");
