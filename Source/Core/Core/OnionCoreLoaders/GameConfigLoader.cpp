...
static std::tuple<OnionConfig::OnionSystem, std::string, std::string> MapINIToRealLocation(const std::string& section, const std::string& key)
{
	                ...
	                std::tuple<OnionConfig::OnionSystem, std::string, std::string>> ini_to_location =
	{
		...
		// OnLoad cheats
		{ std::make_pair("OnLoad", ""),         std::make_tuple(OnionConfig::OnionSystem::SYSTEM_MAIN, "OnLoad", "") },
		...
		// Speedhacks
		{ std::make_pair("Speedhacks", ""), std::make_tuple(OnionConfig::OnionSystem::SYSTEM_MAIN, "Speedhacks", "") },
		...
		// Controls
		{ std::make_pair("Controls", "PadType0"),        std::make_tuple(OnionConfig::OnionSystem::SYSTEM_GCPAD, "Core", "SIDevice0") },
		{ std::make_pair("Controls", "PadType1"),        std::make_tuple(OnionConfig::OnionSystem::SYSTEM_GCPAD, "Core", "SIDevice1") },
		{ std::make_pair("Controls", "PadType2"),        std::make_tuple(OnionConfig::OnionSystem::SYSTEM_GCPAD, "Core", "SIDevice2") },
		{ std::make_pair("Controls", "PadType3"),        std::make_tuple(OnionConfig::OnionSystem::SYSTEM_GCPAD, "Core", "SIDevice3") },
		...
		// Controller profiles
		{ std::make_pair("Controls", "PadProfile1"),      std::make_tuple(OnionConfig::OnionSystem::SYSTEM_GCPAD, "Controls", "PadProfile1") },
		{ std::make_pair("Controls", "PadProfile2"),      std::make_tuple(OnionConfig::OnionSystem::SYSTEM_GCPAD, "Controls", "PadProfile2") },
		{ std::make_pair("Controls", "PadProfile3"),      std::make_tuple(OnionConfig::OnionSystem::SYSTEM_GCPAD, "Controls", "PadProfile3") },
		{ std::make_pair("Controls", "PadProfile4"),      std::make_tuple(OnionConfig::OnionSystem::SYSTEM_GCPAD, "Controls", "PadProfile4") },
		{ std::make_pair("Controls", "WiimoteProfile1"),  std::make_tuple(OnionConfig::OnionSystem::SYSTEM_WIIPAD, "Controls", "WiimoteProfile1") },
		{ std::make_pair("Controls", "WiimoteProfile2"),  std::make_tuple(OnionConfig::OnionSystem::SYSTEM_WIIPAD, "Controls", "WiimoteProfile2") },
		{ std::make_pair("Controls", "WiimoteProfile3"),  std::make_tuple(OnionConfig::OnionSystem::SYSTEM_WIIPAD, "Controls", "WiimoteProfile3") },
		{ std::make_pair("Controls", "WiimoteProfile4"),  std::make_tuple(OnionConfig::OnionSystem::SYSTEM_WIIPAD, "Controls", "WiimoteProfile4") },
		...
		{ std::make_pair("Video_Settings", "ForcedSlowDepth"),              std::make_tuple(OnionConfig::OnionSystem::SYSTEM_GFX, "Settings", "ForcedSlowDepth") },
		...
		{ std::make_pair("Video", "PH_ExtraParam"),           std::make_tuple(OnionConfig::OnionSystem::SYSTEM_GFX, "Video", "PH_ExtraParam") },
	...
	if (it == ini_to_location.end())
	{
		...
		if (!fail)
			return std::make_tuple(OnionConfig::GetSystemFromName(system_str), petal, key);
