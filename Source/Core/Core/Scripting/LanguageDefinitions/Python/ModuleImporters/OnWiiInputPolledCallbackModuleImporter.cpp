...
static PyObject* python_on_wii_input_polled_register_with_auto_deregistration(PyObject* self,
                                                                              PyObject* args)
{
...
static PyMethodDef on_wii_input_polled_api_methods[] = {
    {on_wii_input_polled_register_function_name, python_on_wii_input_polled_register, METH_VARARGS,
     nullptr},
    {on_wii_input_polled_register_with_auto_deregistration_function_name,
     python_on_wii_input_polled_register_with_auto_deregistration, METH_VARARGS, nullptr},
    {on_wii_input_polled_unregister_function_name, python_on_wii_input_polled_unregister,
     METH_VARARGS, nullptr},
    {is_in_wii_input_polled_callback_function_name, python_is_in_wii_input_polled_callback,
     METH_VARARGS, nullptr},
