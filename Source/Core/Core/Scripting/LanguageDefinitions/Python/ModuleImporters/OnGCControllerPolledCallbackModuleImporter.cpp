...
namespace Scripting::Python::OnGCControllerPolledCallbackModuleImporter{
  ...
  static const char* on_gc_controller_polled_get_port_number_of_poll_function_name = "getCurrentPortNumberOfPoll";
  ...
  static PyObject* python_on_gc_controller_polled_set_inputs_for_poll(PyObject* self,
                                                                      PyObject* args)
  {
    return PythonScriptContext::RunFunction(
        self, args, on_gc_controller_polled_class_name,
  ...
  static PyObject* python_on_gc_controller_polled_get_inputs_for_poll(PyObject* self,
                                                                      PyObject* args)
  {
    return PythonScriptContext::RunFunction(
        self, args, on_gc_controller_polled_class_name,
...
static PyMethodDef on_gc_controller_polled_api_methods[] = {
      ...
      {is_in_gc_controller_polled_callback_function_name, python_is_in_gc_controller_polled_callback, METH_VARARGS, nullptr},
      {on_gc_controller_polled_get_port_number_of_poll_function_name, python_on_gc_controller_polled_get_current_port_number_of_poll, METH_VARARGS, nullptr},
      {on_gc_controller_polled_set_inputs_for_poll_function_name, python_on_gc_controller_polled_set_inputs_for_poll, METH_VARARGS, nullptr},
      {on_gc_controller_polled_get_inputs_for_poll_function_name, python_on_gc_controller_polled_get_inputs_for_poll, METH_VARARGS, nullptr},
