...
static PyObject* python_on_frame_start_register(PyObject* self, PyObject* args)
{
  return PythonScriptContext::RunFunction(self, args, on_frame_start_class_name,
                                          on_frame_start_register_function_name);
}

static PyObject* python_on_frame_start_register_with_auto_deregistration(PyObject* self,
                                                                         PyObject* args)
{
  return PythonScriptContext::RunFunction(
      self, args, on_frame_start_class_name,
...
{
  return PythonScriptContext::RunFunction(self, args, on_frame_start_class_name,
                                          on_frame_start_unregister_function_name);
}
...
static PyMethodDef on_frame_start_api_methods[] = {
    ...
    {on_frame_start_unregister_function_name, python_on_frame_start_unregister, METH_VARARGS,
     nullptr},
    {is_in_frame_start_callback_function_name, python_is_in_frame_start_callback, METH_VARARGS,
     nullptr},
