...
FUNCTION_POINTER_TYPE_FOR_FUNCTION_METADATA_API GetFunctionPointer_FunctionMetadata_impl(void* function_metadata)
{
  return reinterpret_cast<FUNCTION_POINTER_TYPE_FOR_FUNCTION_METADATA_API>(castToFunctionMetadataPtr(function_metadata)->function_pointer);
}
...
int GetArgTypeEnumAtIndexInArguments_FunctionMetadata_impl(void* function_metadata, unsigned int index)
{
  return castToFunctionMetadataPtr(function_metadata)->arguments_list.at(index);
}

typedef ArgHolder* (*REAL_FUNCTION_POINTER_TYPE_FOR_FUNCTION_METADATA)(ScriptContext*,std::vector<ArgHolder*>*);
    //  Actually calls the Script API function, and returns the result as an ArgHolder*
void* RunFunctionMain_impl(FUNCTION_POINTER_TYPE_FOR_FUNCTION_METADATA_API function_handle, void* script_context, void* ptr_to_vector_of_arg_holder_ptrs)
{
  return reinterpret_cast<void*>(reinterpret_cast<REAL_FUNCTION_POINTER_TYPE_FOR_FUNCTION_METADATA>(function_handle)(reinterpret_cast<ScriptContext*>(script_context), reinterpret_cast<std::vector<ArgHolder*>*>(ptr_to_vector_of_arg_holder_ptrs)));
}
}  // namespace Scripting
