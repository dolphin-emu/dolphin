...
{
public:
  ScriptQueueEvent(const ScriptQueueEventTypes new_event_type, const int new_unique_script_identifier,
    const char* new_script_filename, const Dolphin_Defined_ScriptContext_APIs::PRINT_CALLBACK_FUNCTION_TYPE& new_print_callback_func,
