...
ArgHolder* GetUnsignedBytesFromRegister(ScriptContext* current_script, std::vector<ArgHolder*>* args_list);
ArgHolder* GetSignedBytesFromRegister(ScriptContext* current_script, std::vector<ArgHolder*>* args_list);
