...
static std::array all_memory_functions_metadata_list = {
    FunctionMetadata("read_u8", "1.0", "read_u8(0X80003421)", ReadU8, ScriptingEnums::ArgTypeEnum::U8,
                     {ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("read_u16", "1.0", "read_u16(0X80003421)", ReadU16, ScriptingEnums::ArgTypeEnum::U16,
                     {ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("read_u32", "1.0", "read_u32(0X80003421)", ReadU32, ScriptingEnums::ArgTypeEnum::U32,
                     {ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("read_u64", "1.0", "read_u64(0X80003421)", ReadU64, ScriptingEnums::ArgTypeEnum::U64,
                     {ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("read_s8", "1.0", "read_s8(0X80003421)", ReadS8, ScriptingEnums::ArgTypeEnum::S8,
                     {ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("read_s16", "1.0", "read_s16(0X80003421)", ReadS16, ScriptingEnums::ArgTypeEnum::S16,
                     {ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("read_s32", "1.0", "read_s32(0X80003421)", ReadS32, ScriptingEnums::ArgTypeEnum::S32,
                     {ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("read_s64", "1.0", "read_s64(0X80003421)", ReadS64, ScriptingEnums::ArgTypeEnum::S64,
                     {ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("read_float", "1.0", "read_float(0X80003421)", ReadFloat, ScriptingEnums::ArgTypeEnum::Float,
                     {ScriptingEnums::ArgTypeEnum::S64}),
    ...
    FunctionMetadata("write_u16", "1.0", "write_u16(0X80003421, 400)", WriteU16,
                     ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::U16}),
    FunctionMetadata("write_u32", "1.0", "write_u32(0X80003421, 500000)", WriteU32,
                     ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::U32}),
    FunctionMetadata("write_u64", "1.0", "write_u64(0X80003421, 7000000)", WriteU64,
                     ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::U64}),
    FunctionMetadata("write_s8", "1.0", "write_s8(0X80003421, -42)", WriteS8, ScriptingEnums::ArgTypeEnum::VoidType,
    ...
    FunctionMetadata("write_s16", "1.0", "write_s16(0X80003421, -500)", WriteS16,
                     ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::S16}),
    FunctionMetadata("write_s32", "1.0", "write_s32(0X80003421, -100000)", WriteS32,
                     ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::S32}),
    FunctionMetadata("write_s64", "1.0", "write_s64(0X80003421, -70000000)", WriteS64,
                     ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("write_float", "1.0", "write_float(0X80003421, 85.64)", WriteFloat,
                     ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::Float}),
    FunctionMetadata("write_double", "1.0", "write_double(0X80003421, 143.51)", WriteDouble,
                     ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::Double}),
    FunctionMetadata("write_string", "1.0", "write_string(0X80003421, \"Hello World!\")",
                     WriteString, ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::String}),
    FunctionMetadata("write_bytes", "1.0", "write_bytes(addressToValueMap)", WriteBytes,
                     ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::AddressToByteMap}),
    FunctionMetadata(
        "writeAllMemoryAsUnsignedBytesToFile", "1.0", "ReadAllMemoryAsUnsignedBytes(myFileName)",
        WriteAllMemoryAsUnsignedBytesToFile, ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::String})};
