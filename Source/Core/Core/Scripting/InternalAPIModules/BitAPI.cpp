...
static std::array all_bit_functions_metadata_list = {
    FunctionMetadata("bitwise_and", "1.0", "bitwise_and(17, 81)", BitwiseAnd, ArgTypeEnum::S64,
                     {ArgTypeEnum::S64, ArgTypeEnum::S64}),
    FunctionMetadata("bitwise_or", "1.0", "bitwise_or(19, 31)", BitwiseOr, ArgTypeEnum::S64,
                     {ArgTypeEnum::S64, ArgTypeEnum::S64}),
    FunctionMetadata("bitwise_not", "1.0", "bitwise_not(41)", BitwiseNot, ArgTypeEnum::S64,
                     {ArgTypeEnum::S64}),
    FunctionMetadata("bitwise_xor", "1.0", "bitwise_xor(21, 40)", BitwiseXor, ArgTypeEnum::S64,
                     {ArgTypeEnum::S64, ArgTypeEnum::S64}),
    FunctionMetadata("logical_and", "1.0", "logical_and(true, false)", LogicalAnd,
                     ArgTypeEnum::Boolean, {ArgTypeEnum::S64, ArgTypeEnum::S64}),
    ...
    FunctionMetadata("bit_shift_left", "1.0", "bit_shift_left(3, 6)", BitShiftLeft,
                     ArgTypeEnum::S64, {ArgTypeEnum::S64, ArgTypeEnum::S64}),
