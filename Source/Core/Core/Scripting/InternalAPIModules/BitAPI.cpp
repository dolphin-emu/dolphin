...
static std::array all_bit_functions_metadata_list = {
    FunctionMetadata("bitwise_and", "1.0", "bitwise_and(17, 81)", BitwiseAnd, ScriptingEnums::ArgTypeEnum::S64,
                     {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("bitwise_or", "1.0", "bitwise_or(19, 31)", BitwiseOr, ScriptingEnums::ArgTypeEnum::S64,
                     {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("bitwise_not", "1.0", "bitwise_not(41)", BitwiseNot, ScriptingEnums::ArgTypeEnum::S64,
                     {ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("bitwise_xor", "1.0", "bitwise_xor(21, 40)", BitwiseXor, ScriptingEnums::ArgTypeEnum::S64,
                     {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("logical_and", "1.0", "logical_and(true, false)", LogicalAnd,
                     ScriptingEnums::ArgTypeEnum::Boolean, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::S64}),
    ...
    FunctionMetadata("logical_xor", "1.0", "logical_xor(true, false)", LogicalXor,
                     ScriptingEnums::ArgTypeEnum::Boolean, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("logical_not", "1.0", "logical_not(true)", LogicalNot, ScriptingEnums::ArgTypeEnum::Boolean,
                     {ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("bit_shift_left", "1.0", "bit_shift_left(3, 6)", BitShiftLeft,
                     ScriptingEnums::ArgTypeEnum::S64, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::S64}),
