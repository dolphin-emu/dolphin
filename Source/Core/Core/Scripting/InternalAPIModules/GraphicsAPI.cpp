...
static std::array all_graphics_functions_metadata_list = {
    FunctionMetadata("drawLine", "1.0", "drawLine(40.3, 80, 60.3, 80, 0.8, lineColorString)",
                     ...
                     {ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float,
                      ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::String}),
    ...
    FunctionMetadata(
        ...
        {ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float,
         ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::String}),

    FunctionMetadata(
        "drawFilledTriangle", "1.0", "drawFilledTriangle(x1, y1, x2, y2, x3, y3, color)",
        DrawFilledTriangle, ScriptingEnums::ArgTypeEnum::VoidType,
        {ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float,
         ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::String}),
    ...
    FunctionMetadata("drawEmptyPolygon", "1.0",
                     ...
                     {ScriptingEnums::ArgTypeEnum::ListOfPoints, ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::String}),
    ...
    FunctionMetadata(
        ...
        {ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::Float, ScriptingEnums::ArgTypeEnum::String, ScriptingEnums::ArgTypeEnum::String}),

    FunctionMetadata("addCheckbox", "1.0", "addCheckbox(checkboxLabel, 42)", AddCheckbox,
                     ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::String, ScriptingEnums::ArgTypeEnum::S64}),
    ...
    FunctionMetadata("setCheckboxValue", "1.0", "setCheckboxValue(42, true)", SetCheckboxValue,
                     ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::Boolean}),
    ...
    FunctionMetadata("addRadioButton", "1.0", "addRadioButton(\"apples\", 42, 0)", AddRadioButton,
                     ScriptingEnums::ArgTypeEnum::VoidType,
                     {ScriptingEnums::ArgTypeEnum::String, ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::S64}),
    FunctionMetadata("getRadioButtonGroupValue", "1.0", "getRadioButtonGroupValue((42)",
                     GetRadioButtonGroupValue, ScriptingEnums::ArgTypeEnum::S64, {ScriptingEnums::ArgTypeEnum::S64}),
    ...
    FunctionMetadata("addTextBox", "1.0", "addTextBox(42, \"Textbox Label\")", AddTextBox,
                     ScriptingEnums::ArgTypeEnum::VoidType, {ScriptingEnums::ArgTypeEnum::S64, ScriptingEnums::ArgTypeEnum::String}),
    ...
    FunctionMetadata("addButton", "1.0",
                     ...
                     ScriptingEnums::ArgTypeEnum::VoidType,
                     {ScriptingEnums::ArgTypeEnum::String, ScriptingEnums::ArgTypeEnum::S64,
                      ScriptingEnums::ArgTypeEnum::RegistrationForButtonCallbackInputType, ScriptingEnums::ArgTypeEnum::Float,
                      ScriptingEnums::ArgTypeEnum::Float}),
    FunctionMetadata("pressButton", "1.0", "pressButton(42)", PressButton, ScriptingEnums::ArgTypeEnum::VoidType,
                     {ScriptingEnums::ArgTypeEnum::S64}),

    FunctionMetadata("newLine", "1.0", "newLine(10.0)", NewLine, ScriptingEnums::ArgTypeEnum::VoidType,
                     {ScriptingEnums::ArgTypeEnum::Float}),
    ...
    FunctionMetadata("endWindow", "1.0", "endWindow()", EndWindow, ScriptingEnums::ArgTypeEnum::VoidType, {})};
