...
static std::array all_config_functions_metadata_list = {
    ...
    FunctionMetadata("deleteEnumConfigSettingFromLayer", "1.0", "deleteEnumConfigSettingForLayer(\"GlobalGame\", \"Main\", \"Core\", \"SlotA\", ""\"EXIDeviceType\")", DeleteEnumConfigSettingFromLayer, ArgTypeEnum::Boolean, {ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String}),
