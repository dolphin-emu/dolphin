...
static std::array all_config_functions_metadata_list = {
    ...
    FunctionMetadata("getLayerNames_mostGlobalFirst", "1.0", "getLayerNames_mostGlobalFirst()",
                     GetLayerNames_MostGlobalFirst, ArgTypeEnum::String, {}),
    FunctionMetadata("doesLayerExist", "1.0", "doesLayerExist(\"Movie\")", DoesLayerExist,
                     ArgTypeEnum::Boolean, {ArgTypeEnum::String}),
    ...
    FunctionMetadata("getListOfValidValuesForEnumType", "1.0",
                     ...
                     GetListOfValidValuesForEnumType, ArgTypeEnum::String, {ArgTypeEnum::String}),

    FunctionMetadata(
        "getBooleanConfigSettingForLayer", "1.0",
        "getBooleanConfigSettingForLayer(\"GlobalGame\", \"Main\", \"Interface\", "
        "\"debugModeEnabled\")",
        GetBooleanConfigSettingForLayer, ArgTypeEnum::Boolean,
    ...
    FunctionMetadata("setUnsignedIntConfigSettingForLayer", "1.0",
                     ...
                     "\"MEM1Size\", 500)",
                     SetUnsignedIntConfigSettingForLayer, ArgTypeEnum::VoidType,
                     {ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String,
                      ArgTypeEnum::String, ArgTypeEnum::U32}),
    FunctionMetadata("setFloatConfigSettingForLayer", "1.0",
                     "setFloatConfigSettingForLayer(\"GlobalGame\", \"Main\", \"Core\", "
                     "\"EmulationSpeed\", 3.4)",
                     SetFloatConfigSettingForLayer, ArgTypeEnum::VoidType,
                     {ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String,
    ...
    FunctionMetadata("setStringConfigSettingForLayer", "1.0",
                     ...
                     SetStringConfigSettingForLayer, ArgTypeEnum::VoidType,
                     {ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String,
                      ArgTypeEnum::String, ArgTypeEnum::String}),
    FunctionMetadata("setEnumConfigSettingForLayer", "1.0",
                     ...
                     SetEnumConfigSettingForLayer, ArgTypeEnum::VoidType,
                     {ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String,
                      ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String}),

    FunctionMetadata(
        "deleteBooleanConfigSettingFromLayer", "1.0",
        "deleteBooleanConfigSettingFromLayer(\"GlobalGame\", \"Main\", \"Interface\", "
        "\"debugModeEnabled\")",
        DeleteBooleanConfigSettingFromLayer, ArgTypeEnum::Boolean,
        {ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String}),
    FunctionMetadata(
        "deleteSignedIntConfigSettingFromLayer", "1.0",
        "deleteSignedIntConfigSettingFromLayer(\"GlobalGame\", \"Main\", \"Core\", "
        "\"TimingVariance\")",
        DeleteSignedIntConfigSettingFromLayer, ArgTypeEnum::Boolean,
        {ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String}),
    FunctionMetadata(
        "deleteUnsignedIntConfigSettingFromLayer", "1.0",
        "deleteUnsignedIntConfigSettingFromLayer(\"GlobalGame\", \"Main\", \"Core\", "
        "\"MEM1Size\")",
        DeleteUnsignedIntConfigSettingFromLayer, ArgTypeEnum::Boolean,
        {ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String}),
    FunctionMetadata(
        "deleteFloatConfigSettingFromLayer", "1.0",
        "deleteFloatConfigSettingFromLayer(\"GlobalGame\", \"Main\", \"Core\", "
        "\"EmulationSpeed\")",
        DeleteFloatConfigSettingFromLayer, ArgTypeEnum::Boolean,
        {ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String}),
    FunctionMetadata(
        "deleteStringConfigSettingFromLayer", "1.0",
        "deleteStringConfigSettingFromLayer(\"GlobalGame\", \"Main\", \"Core\", "
        "\"MemcardAPath\")",
        DeleteStringConfigSettingFromLayer, ArgTypeEnum::Boolean,
        {ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String}),
    FunctionMetadata(
        "deleteEnumConfigSettingFromLayer", "1.0",
        "deleteEnumConfigSettingForLayer(\"GlobalGame\", \"Main\", \"Core\", \"SlotA\", "
        "\"EXIDeviceType\")",
        DeleteEnumConfigSettingFromLayer, ArgTypeEnum::Boolean,
        {ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String,
         ArgTypeEnum::String}),
    ...
    FunctionMetadata("getBooleanConfigSetting", "1.0",
                     ...
                     "\"debugModeEnabled\")",
                     GetBooleanConfigSetting, ArgTypeEnum::Boolean,
                     {ArgTypeEnum::String, ArgTypeEnum::String, ArgTypeEnum::String}),
