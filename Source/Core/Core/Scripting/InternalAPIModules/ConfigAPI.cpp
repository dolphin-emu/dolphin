...
static std::array all_config_functions_metadata_list = {
    ...
    FunctionMetadata("getListOfValidValuesForEnumType", "1.0",
                     ...
                     GetListOfValidValuesForEnumType, ScriptingEnums::ArgTypeEnum::String, {ScriptingEnums::ArgTypeEnum::String}),
    ...
    FunctionMetadata(
        ...
        {ScriptingEnums::ArgTypeEnum::String, ScriptingEnums::ArgTypeEnum::String, ScriptingEnums::ArgTypeEnum::String, ScriptingEnums::ArgTypeEnum::String}),
    FunctionMetadata(
    ...
    FunctionMetadata("getEnumConfigSettingForLayer", "1.0",
                     ...
                     {ScriptingEnums::ArgTypeEnum::String, ScriptingEnums::ArgTypeEnum::String, ScriptingEnums::ArgTypeEnum::String,
    ...
    FunctionMetadata("setBooleanConfigSettingForLayer", "1.0",
                     ...
                     {ScriptingEnums::ArgTypeEnum::String, ScriptingEnums::ArgTypeEnum::String, ScriptingEnums::ArgTypeEnum::String,
                      ScriptingEnums::ArgTypeEnum::String, ScriptingEnums::ArgTypeEnum::Boolean}),
