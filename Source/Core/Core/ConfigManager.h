...
struct SConfig : NonCopyable
{
  ...
  bool bJITNoBlockCache = false, bJITNoBlockLinking = false;
  bool bJITOff = false;
  bool bJITLoadStoreOff = false, bJITLoadStorelXzOff = false, bJITLoadStorelwzOff = false,
       bJITLoadStorelbzxOff = false;
  ...
  // Interface settings
  bool bConfirmStop = false, bHideCursor = false, bAutoHideCursor = false, bUsePanicHandlers = true,
