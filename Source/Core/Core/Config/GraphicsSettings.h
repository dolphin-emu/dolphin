...
extern const ConfigInfo<bool> GFX_CUSTOM_TEXTURES;
extern const ConfigInfo<bool> GFX_CONVERT_CUSTOM_TEXTURES;
extern const ConfigInfo<bool> GFX_PREFETCH_CUSTOM_TEXTURES;
