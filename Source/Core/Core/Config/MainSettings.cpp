...
const Info<std::string> MAIN_SD_IMAGE_PATH{{System::Main, "General", "WiiSDCardPath"}, ""};
const Info<std::string> MAIN_SD_FOLDER_PATH{{System::Main, "General", "WiiSDCardFolderPath"}, ""};
