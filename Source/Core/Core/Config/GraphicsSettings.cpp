...
const Info<bool> GFX_FRAME_GENERATION_ENABLED{{System::GFX, "FrameGeneration", "Enabled"}, false};
const Info<u32> GFX_FRAME_GENERATION_MULTIPLIER{{System::GFX, "FrameGeneration", "Multiplier"}, 8};
