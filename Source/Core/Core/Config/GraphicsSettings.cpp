...
const Info<AspectMode> GFX_ASPECT_RATIO{{System::GFX, "Settings", "AspectRatio"}, AspectMode::Analog};
...
const Info<int> GFX_TEXTURE_PACK{{System::GFX, "Settings", "TexturePack"}, 0};
