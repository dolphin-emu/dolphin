...
const Info<u32> SYSCONF_LANGUAGE{
    {System::SYSCONF, "IPL", "LNG"}, static_cast<u32>(GetDefaultLanguage())};
...
const std::array<SYSCONFSetting, 11> SYSCONF_SETTINGS{{{&SYSCONF_SCREENSAVER,
                                                           SysConf::Entry::Type::Byte},
    ...
    {&SYSCONF_PAL60, SysConf::Entry::Type::Byte}, {&SYSCONF_SOUND_MODE, SysConf::Entry::Type::Byte},
