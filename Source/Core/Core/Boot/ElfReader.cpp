...
const char* ElfReader::GetSectionName(const int section) const
{
...
bool ElfReader::LoadIntoMemory(Core::System& system, const bool only_in_mem1) const
{
...
SectionID ElfReader::GetSectionByName(const char* name, const int firstSection) const
{
