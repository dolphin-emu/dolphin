...
const std::map<const std::pair<const u16, const u16>, SkyData> list_skylanders = {
    ...
    {{6, 0x4810}, {"Dino-Rang (Eon's Elite)", Game::Superchargers, Element::Earth, Type::Skylander}},
    ...
    {{7, 0x1214}, {"Prism Break (White Flocked LightCore)", Game::Giants, Element::Earth, Type::Skylander}},
    ...
    {{9, 0x2C02}, {"Eruptor (Volcanic Lava Barf)", Game::SwapForce, Element::Fire, Type::Skylander}},
    ...
    {{15, 0x3810}, {"Slam Bam (Eon's Elite)", Game::Superchargers, Element::Water, Type::Skylander}},
    ...
    {{19, 0x2C02}, {"Trigger Happy (Springtime Big Bang)", Game::SwapForce, Element::Tech, Type::Skylander}},
    ...
    {{23, 0x1814}, {"Wrecking Ball (Metallic Purple)", Game::Giants, Element::Magic, Type::Skylander}},
    ...
    {{30, 0x2816}, {"Chop Chop (Green Twin Blade)", Game::SwapForce, Element::Undead, Type::Skylander}},
    ...
    {{31, 0x4810}, {"Ghost Roaster (Eon's Elite)", Game::Superchargers, Element::Undead, Type::Skylander}},
    ...
    {{105, 0x281A}, {"Hot Dog (Red Flame Frito-Lay Fire Bone)", Game::SwapForce, Element::Fire, Type::Skylander}},
    {{105, 0x281B}, {"Hot Dog (Green Flame Frito-Lay Fire Bone)", Game::SwapForce, Element::Fire, Type::Skylander}},
    {{105, 0x281C}, {"Hot Dog (Purple Flame Frito-Lay Fire Bone)", Game::SwapForce, Element::Fire, Type::Skylander}},
    ...
    {{108, 0x3C02}, {"Pop Fizz (Love Potion Fizzy Frenzy)", Game::TrapTeam, Element::Magic, Type::Skylander}},
    ...
    {{111, 0x2819}, {"Sprocket (Heavy Metal Heavy Duty)", Game::SwapForce, Element::Tech, Type::Skylander}},
    ...
    {{115, 0x1011}, {"Fright Rider (Glow in the Dark)", Game::Giants, Element::Undead, Type::Skylander}},
    ...
    {{1001, 0x2403}, {"Free Ranger (Legendary) (Bottom)", Game::SwapForce, Element::Air, Type::Swapper}},
    ...
    {{1003, 0x2016}, {"Doom Stone (Gold & Bronze) (Bottom)", Game::SwapForce, Element::Earth, Type::Swapper}},
    ...
    {{1005, 0x2004}, {"Fire Kraken (Gold) (Bottom)", Game::SwapForce, Element::Fire, Type::Swapper}},
    {{1005, 0x2402}, {"Fire Kraken (Jade) (Bottom)", Game::SwapForce, Element::Fire, Type::Swapper}},
    {{1006, 0x2000}, {"Stink Bomb (Bottom)", Game::SwapForce, Element::Life, Type::Swapper}},
    {{1006, 0x2016}, {"Stink Bomb (Silver & Gold) (Bottom)", Game::SwapForce, Element::Life, Type::Swapper}},
    ...
    {{1008, 0x2402}, {"Hoot Loop (Enchanted) (Bottom)", Game::SwapForce, Element::Magic, Type::Swapper}},
    {{1009, 0x2000}, {"Trap Shadow (Bottom)", Game::SwapForce, Element::Magic, Type::Swapper}},
    {{1009, 0x2016}, {"Trap Shadow (Bronze & Silver) (Bottom)", Game::SwapForce, Element::Magic, Type::Swapper}},
    {{1010, 0x2000}, {"Magna Charge (Bottom)", Game::SwapForce, Element::Tech, Type::Swapper}},
    {{1010, 0x2402}, {"Magna Charge (Nitro) (Bottom)", Game::SwapForce, Element::Tech, Type::Swapper}},
    ...
    {{1012, 0x2403}, {"Night Shift (Legendary) (Bottom)", Game::SwapForce, Element::Undead, Type::Swapper}},
    {{1013, 0x2000}, {"Rattle Shake (Bottom)", Game::SwapForce, Element::Undead, Type::Swapper}},
    {{1013, 0x2402}, {"Rattle Shake (Quickdraw) (Bottom)", Game::SwapForce, Element::Undead, Type::Swapper}},
    {{1014, 0x2000}, {"Freeze Blade (Bottom)", Game::SwapForce, Element::Water, Type::Swapper}},
    {{1014, 0x2402}, {"Freeze Blade (Nitro) (Bottom)", Game::SwapForce, Element::Water, Type::Swapper}},
    {{1015, 0x2000}, {"Wash Buckler (Bottom)", Game::SwapForce, Element::Water, Type::Swapper}},
    {{1015, 0x2018}, {"Wash Buckler (Gold) (Bottom)", Game::SwapForce, Element::Water, Type::Swapper}},
    {{1015, 0x2402}, {"Wash Buckler (Dark) (Bottom)", Game::SwapForce, Element::Water, Type::Swapper}},
    ...
    {{2001, 0x2403}, {"Free Ranger (Legendary) (Top)", Game::SwapForce, Element::Air, Type::Swapper}},
    ...
    {{2003, 0x2016}, {"Doom Stone (Gold & Bronze) (Top)", Game::SwapForce, Element::Earth, Type::Swapper}},
    ...
    {{2006, 0x2016}, {"Stink Bomb (Silver & Gold) (Top)", Game::SwapForce, Element::Life, Type::Swapper}},
    ...
    {{2008, 0x2402}, {"Hoot Loop (Enchanted) (Top)", Game::SwapForce, Element::Magic, Type::Swapper}},
    {{2009, 0x2000}, {"Trap Shadow (Top)", Game::SwapForce, Element::Magic, Type::Swapper}},
    {{2009, 0x2016}, {"Trap Shadow (Bronze & Silver) (Top)", Game::SwapForce, Element::Magic, Type::Swapper}},
    ...
    {{2012, 0x2403}, {"Night Shift (Legendary) (Top)", Game::SwapForce, Element::Undead, Type::Swapper}},
    {{2013, 0x2000}, {"Rattle Shake (Top)", Game::SwapForce, Element::Undead, Type::Swapper}},
    {{2013, 0x2402}, {"Rattle Shake (Quickdraw) (Top)", Game::SwapForce, Element::Undead, Type::Swapper}},
    {{2014, 0x2000}, {"Freeze Blade (Top)", Game::SwapForce, Element::Water, Type::Swapper}},
    {{2014, 0x2402}, {"Freeze Blade (Nitro) (Top)", Game::SwapForce, Element::Water, Type::Swapper}},
    ...
    {{3009, 0x2602}, {"Star Strike (Enchanted LightCore)", Game::SwapForce, Element::Magic, Type::Skylander}},
    ...
    {{3011, 0x2404}, {"Wind Up (Gear Head Vicarious Visions)", Game::SwapForce, Element::Tech, Type::Skylander}},
    ...
    {{3013, 0x2206}, {"Grim Creeper (LightCore)", Game::SwapForce, Element::Undead, Type::Skylander}},
    {{3013, 0x2603}, {"Grim Creeper (Legendary LightCore)", Game::SwapForce, Element::Undead, Type::Skylander}},
    ...
    {{3224, 0x4004}, {"Hot Streak (Event Exclusive)", Game::Superchargers, Element::Fire, Type::Vehicle}},
    ...
    {{3228, 0x4402}, {"Stealth Stinger (Nitro)", Game::Superchargers, Element::Life, Type::Vehicle}},
    {{3228, 0x450F}, {"Stealth Stinger (Instant)", Game::Superchargers, Element::Life, Type::Vehicle}},
    {{3231, 0x4000}, {"Dive Bomber", Game::Superchargers, Element::Water, Type::Vehicle}},
    {{3231, 0x4402}, {"Dive Bomber (Spring Ahead)", Game::Superchargers, Element::Water, Type::Vehicle}},
    ...
    {{3234, 0x4402}, {"Gold Rusher (Power Blue)", Game::Superchargers, Element::Tech, Type::Vehicle}},
    {{3235, 0x4000}, {"Shield Striker", Game::Superchargers, Element::Tech, Type::Vehicle}},
    {{3235, 0x401E}, {"Shield Striker (Patina)", Game::Superchargers, Element::Tech, Type::Vehicle}},
    {{3236, 0x4000}, {"Sun Runner", Game::Superchargers, Element::Light, Type::Vehicle}},
    {{3236, 0x4403}, {"Sun Runner (Legendary)", Game::Superchargers, Element::Light, Type::Vehicle}},
    ...
    {{3238, 0x4402}, {"Splatter Splasher (Power Blue)", Game::Superchargers, Element::Magic, Type::Vehicle}},
    ...
    {{3406, 0x410E}, {"Stormblade (Snow-Brite)", Game::Superchargers, Element::Air, Type::Skylander}},
    {{3411, 0x4100}, {"Smash Hit", Game::Superchargers, Element::Earth, Type::Skylander}},
    {{3411, 0x4502}, {"Smash Hit (Steel Plated)", Game::Superchargers, Element::Earth, Type::Skylander}},
    ...
    {{3413, 0x4503}, {"Jet-Vac (Legendary Hurricane)", Game::Superchargers, Element::Air, Type::Skylander}},
    {{3414, 0x4100}, {"Trigger Happy (Double Dare)", Game::Superchargers, Element::Tech, Type::Skylander}},
    {{3414, 0x4502}, {"Trigger Happy (Power Blue Double Dare)", Game::Superchargers, Element::Tech, Type::Skylander}},
    {{3415, 0x4100}, {"Stealth Elf (Super Shot)", Game::Superchargers, Element::Life, Type::Skylander}},
    {{3415, 0x4502}, {"Stealth Elf (Dark Super Shot)", Game::Superchargers, Element::Life, Type::Skylander}},
    {{3415, 0x450F}, {"Stealth Elf (Instant Super Shot)", Game::Superchargers, Element::Life, Type::Skylander}},
    {{3416, 0x4100}, {"Terrafin (Shark Shooter)", Game::Superchargers, Element::Earth, Type::Skylander}},
    {{3417, 0x4100}, {"Roller Brawl (Bone Bash)", Game::Superchargers, Element::Undead, Type::Skylander}},
    {{3417, 0x411E}, {"Roller Brawl (Bronze Bone Bash)", Game::Superchargers, Element::Undead, Type::Skylander}},
    {{3417, 0x4503}, {"Roller Brawl (Legendary Bone Bash)", Game::Superchargers, Element::Undead, Type::Skylander}},
    {{3420, 0x4100}, {"Pop Fizz (Big Bubble)", Game::Superchargers, Element::Magic, Type::Skylander}},
    {{3420, 0x450E}, {"Pop Fizz (Birthday Bash Big Bubble)", Game::Superchargers, Element::Magic, Type::Skylander}},
    {{3421, 0x4100}, {"Eruptor (Lava Lance)", Game::Superchargers, Element::Fire, Type::Skylander}},
    {{3421, 0x411E}, {"Eruptor (Patina Lava Lance)", Game::Superchargers, Element::Fire, Type::Skylander}},
    {{3422, 0x4100}, {"Gill Grunt (Deep Dive)", Game::Superchargers, Element::Water, Type::Skylander}},
    {{3423, 0x4100}, {"Donkey Kong (Turbo Charge)", Game::Superchargers, Element::Life, Type::Skylander}},
    {{3423, 0x4502}, {"Donkey Kong (Dark Turbo Charge)", Game::Superchargers, Element::Life, Type::Skylander}},
    {{3424, 0x4100}, {"Bowser (Hammer Slam)", Game::Superchargers, Element::Fire, Type::Skylander}},
    {{3424, 0x4502}, {"Bowser (Dark Hammer Slam)", Game::Superchargers, Element::Fire, Type::Skylander}},
    {{3425, 0x4100}, {"Dive-Clops", Game::Superchargers, Element::Water, Type::Skylander}},
    {{3425, 0x450E}, {"Dive-Clops (Missile-Tow)", Game::Superchargers, Element::Water, Type::Skylander}},
    {{3425, 0x450F}, {"Dive-Clops (Instant)", Game::Superchargers, Element::Water, Type::Skylander}},
    {{3426, 0x4100}, {"Astroblast", Game::Superchargers, Element::Tech, Type::Skylander}},
    {{3426, 0x4503}, {"Astroblast (Legendary)", Game::Superchargers, Element::Light, Type::Skylander}},
    ...
    {{3428, 0x450D}, {"Thrillipede (Eggcited)", Game::Superchargers, Element::Life, Type::Skylander}},
