...
public:
  ...
  // Schedule a transfer to submitted as soon as possible.
...
private:
  ...
  Common::WaitableSPSCQueue<libusb_transfer*> m_completed_transfers;
  ...
  // We track this so we can safely inject our own commands.
