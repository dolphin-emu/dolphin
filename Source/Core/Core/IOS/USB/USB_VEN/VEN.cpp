...
s32 USB_VEN::SubmitTransfer(USB::Device& device, const IOCtlVRequest& ioctlv) const
{
...
IPCReply USB_VEN::GetDeviceInfo(const USBV5Device& device, const IOCtlRequest& request) const
{
