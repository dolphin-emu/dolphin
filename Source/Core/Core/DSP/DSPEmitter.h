...
private:
	...
	void set_long_acc(int reg, Gen::X64Reg acc = Gen::EAX);
	void get_acc_h(int reg, Gen::X64Reg acc = Gen::EAX, bool sign = true);
	void set_acc_h(int reg, Gen::OpArg arg = R(Gen::EAX));
	void get_acc_m(int reg, Gen::X64Reg acc = Gen::EAX, bool sign = true);
	void set_acc_m(int reg, Gen::OpArg arg = R(Gen::EAX));
	void get_acc_l(int reg, Gen::X64Reg acc = Gen::EAX, bool sign = true);
	void set_acc_l(int reg, Gen::OpArg arg = R(Gen::EAX));
	void get_long_acx(int reg, Gen::X64Reg acx = Gen::EAX);
	void get_ax_l(int reg, Gen::X64Reg acx = Gen::EAX);
	void get_ax_h(int reg, Gen::X64Reg acc = Gen::EAX);
	void get_long_acc(int reg, Gen::X64Reg acc = Gen::EAX);
};
