...
{
public:
  inline static u8 (*read_u8_from_domain_function)(u32) = NULL;
  inline static u16 (*read_u16_from_domain_function)(u32) = NULL;
  inline static u32 (*read_u32_from_domain_function)(u32) = NULL;
  inline static u64 (*read_u64_from_domain_function)(u32) = NULL;
  inline static std::string (*get_string_from_domain_function)(u32, u32) = NULL;
  inline static u8* (*get_pointer_to_domain_function)(u32) = NULL;
  inline static void (*write_u8_to_domain_function)(u32, u8) = NULL;
  inline static void (*write_u16_to_domain_function)(u32, u16) = NULL;
  inline static void (*write_u32_to_domain_function)(u32, u32) = NULL;
  inline static void (*write_u64_to_domain_function)(u32, u64) = NULL;
  inline static void (*copy_string_to_domain_function)(u32, const char*, size_t) = NULL;
...
int LuaMemoryBaseApi<T>::do_read_null_terminated_string(lua_State* luaState)
{
  ...
  std::string returnResult =
      get_string_from_domain_function(address, (u32)(memPointerCurrent - memPointerStart));
  lua_pushfstring(luaState, returnResult.c_str());
  return 1;
}
