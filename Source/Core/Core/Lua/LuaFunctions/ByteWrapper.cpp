...
#include <type_traits>
  ...
  ByteWrapper* ByteWrapper::CreateByteWrapperFromU8(u8 value)
  {
    ...
    returnResult->byteType = NumberType::UNDEFINED;
    return returnResult;
  }
  ...
  bool ByteWrapper::typeSizeCheck(ByteWrapper* byteWrapperPointer, NumberType desiredType)
  {
    switch (desiredType)
    {
  ...
  {
    byteType = NumberType::UNSIGNED_8;
    numBytesUsedByType = 1;
  ...
  {
    byteType = NumberType::UNSIGNED_16;
  ...
  {
    byteType = NumberType::UNSIGNED_32;
  ...
  {
    byteType = NumberType::UNSIGNED_64;
  ...
  void ByteWrapper::setType(NumberType newType)
  {
    switch (newType)
    {
    case NumberType::UNSIGNED_8:
  ...
  bool ByteWrapper::doComparisonOperation(const ByteWrapper& otherByteWrapper, ByteWrapper::OPERATIONS operation) const
  {
    ...
    if (totalBytesAllocated <= 0 || otherByteWrapper.totalBytesAllocated <= 0 ||
        byteType == NumberType::UNDEFINED || otherByteWrapper.byteType == NumberType::UNDEFINED)
    {
  ...
  ByteWrapper ByteWrapper::doNonComparisonOperation(const ByteWrapper& otherByteWrapper, OPERATIONS operation) const
{
  ...
  {
    if (totalBytesAllocated <= 0 || byteType == NumberType::UNDEFINED)
    {
      throw std::invalid_argument("Error: type must be specified before bit operation can be performed on ByteWrapper");
    }
