...
public:
  ...
  void PushWiimoteSpeakerSamples(u32 wiimote_index, const s16* samples, u32 num_samples, u32 sample_rate);
...
private:
  ...
  std::array<std::unique_ptr<MixerFifo>, 4> m_wiimote_speaker_mixers; // max # wiimotes = 4, one mixer per wiimote
