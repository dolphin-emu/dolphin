...
void OpenALStream::SoundLoop()
{
  ...
  const ALenum AL_FORMAT_STEREO32 = 0x1203;
#else
  const ALenum AL_FORMAT_STEREO32 = 0;
#endif
  ...
  // Checks if a X-Fi is being used. If it is, enable FIXED32 support as this sound card
  // is the only one that supports it for now.
