...
// Utilized for menu iterms where their labels don't matter on initial construction.
// This is necessary, as wx, in it's infinite glory, asserts if a menu item is appended to a menu
