...
void GeneralConfigPane::InitializeGUI()
{
	...
	m_analytics_new_id->SetToolTip(_("Usage statistics reporting uses a unique per-machine identifier to distinguish users from one another. This button generates a new identifier for this machine which is dissociated from the previous one."));
