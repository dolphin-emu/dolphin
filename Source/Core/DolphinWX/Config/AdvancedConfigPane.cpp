...
void AdvancedConfigPane::LoadGUIValues()
{
  ...
  wxDateTime custom_rtc = wxDateTime(static_cast<time_t>(SConfig::GetInstance().m_customRTCValue));
...
{
  temp_date = m_custom_rtc_date_picker->GetValue().GetTicks();
  SConfig::GetInstance().m_customRTCValue = temp_date + temp_time;
  m_custom_rtc_time_picker->SetValue(static_cast<time_t>(SConfig::GetInstance().m_customRTCValue));
}
...
void AdvancedConfigPane::OnCustomRTCTimeChanged(wxCommandEvent& event)
{
  temp_time = m_custom_rtc_time_picker->GetValue().GetTicks() - temp_date;
  SConfig::GetInstance().m_customRTCValue = temp_date + temp_time;
  m_custom_rtc_date_picker->SetValue(static_cast<time_t>(SConfig::GetInstance().m_customRTCValue));
}
