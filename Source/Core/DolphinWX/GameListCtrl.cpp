                                ...
                                long sortData = GameListCtrl::COLUMN_TITLE)
{
  ...
  {
    const int nState1 = (iso1->GetVRState() << 4) | iso1->GetEmuState(),
...
void GameListCtrl::InitBitmaps()
{
  ...
  InitBitmap(img_list, &platform_indexes, this, platform_bmp_size, DiscIO::Platform::ELF_DOL,
             "Platform_File");
  InitBitmap(img_list, &platform_indexes, this, platform_bmp_size, DiscIO::Platform::TRIFORCE_DISC, "Platform_Triforce");
  InitBitmap(img_list, &platform_indexes, this, platform_bmp_size, DiscIO::Platform::N64_WAD, "Platform_N64");
  InitBitmap(img_list, &platform_indexes, this, platform_bmp_size, DiscIO::Platform::SNES_WAD, "Platform_SNES");
  InitBitmap(img_list, &platform_indexes, this, platform_bmp_size, DiscIO::Platform::NES_WAD, "Platform_NES");
  InitBitmap(img_list, &platform_indexes, this, platform_bmp_size, DiscIO::Platform::TG16_WAD, "Platform_Turbografx");
  InitBitmap(img_list, &platform_indexes, this, platform_bmp_size, DiscIO::Platform::C64_WAD, "Platform_C64");
  InitBitmap(img_list, &platform_indexes, this, platform_bmp_size, DiscIO::Platform::MSX_WAD, "Platform_MSX");
  InitBitmap(img_list, &platform_indexes, this, platform_bmp_size, DiscIO::Platform::SMS_WAD, "Platform_SMS");
  InitBitmap(img_list, &platform_indexes, this, platform_bmp_size, DiscIO::Platform::GENESIS_WAD, "Platform_Genesis");
  InitBitmap(img_list, &platform_indexes, this, platform_bmp_size, DiscIO::Platform::ARCADE_WAD, "Platform_Arcade");
  InitBitmap(img_list, &platform_indexes, this, platform_bmp_size, DiscIO::Platform::NEOGEO_WAD, "Platform_NeoGeo");
...
void GameListCtrl::UpdateItemAtColumn(long index, int column)
{
  ...
  case COLUMN_PLATFORM:
  {
    SetItemColumnImage(index, COLUMN_PLATFORM,
                       m_image_indexes.platform[static_cast<size_t>(iso_file.GetDetailedPlatform())]);
    break;
  }
  case COLUMN_BANNER:
  {
  ...
  case COLUMN_VR_STATE:
    SetItemColumnImage(index, COLUMN_VR_STATE, m_image_indexes.emu_state[iso_file.GetVRState()]);
    break;
  case COLUMN_COUNTRY:
...
{
  std::string filename(File::GetUserPath(D_CACHE_IDX) + "wx_gamelist_vr.cache");
