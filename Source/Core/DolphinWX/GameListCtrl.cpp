...
void CGameListCtrl::InitBitmaps()
{
  ...
  m_PlatformImageIndex[DiscIO::IVolume::TRIFORCE_DISC] =
      m_imageListSmall->Add(WxUtils::LoadResourceBitmap("Platform_Triforce", size));
  m_PlatformImageIndex[DiscIO::IVolume::N64_WAD] =
      m_imageListSmall->Add(WxUtils::LoadResourceBitmap("Platform_N64", size));
  m_PlatformImageIndex[DiscIO::IVolume::SNES_WAD] =
      m_imageListSmall->Add(WxUtils::LoadResourceBitmap("Platform_SNES", size));
  m_PlatformImageIndex[DiscIO::IVolume::NES_WAD] =
      m_imageListSmall->Add(WxUtils::LoadResourceBitmap("Platform_NES", size));
  m_PlatformImageIndex[DiscIO::IVolume::TG16_WAD] =
      m_imageListSmall->Add(WxUtils::LoadResourceBitmap("Platform_Turbografx", size));
  m_PlatformImageIndex[DiscIO::IVolume::C64_WAD] =
      m_imageListSmall->Add(WxUtils::LoadResourceBitmap("Platform_C64", size));
  m_PlatformImageIndex[DiscIO::IVolume::MSX_WAD] =
      m_imageListSmall->Add(WxUtils::LoadResourceBitmap("Platform_MSX", size));
  m_PlatformImageIndex[DiscIO::IVolume::SMS_WAD] =
      m_imageListSmall->Add(WxUtils::LoadResourceBitmap("Platform_SMS", size));
  m_PlatformImageIndex[DiscIO::IVolume::GENESIS_WAD] =
      m_imageListSmall->Add(WxUtils::LoadResourceBitmap("Platform_Genesis", size));
  m_PlatformImageIndex[DiscIO::IVolume::ARCADE_WAD] =
      m_imageListSmall->Add(WxUtils::LoadResourceBitmap("Platform_Arcade", size));
  m_PlatformImageIndex[DiscIO::IVolume::NEOGEO_WAD] =
      m_imageListSmall->Add(WxUtils::LoadResourceBitmap("Platform_NeoGeo", size));
