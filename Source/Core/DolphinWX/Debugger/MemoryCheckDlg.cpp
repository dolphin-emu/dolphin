    ...
    : wxDialog(parent, wxID_ANY, _("Add a Memory Check")), m_parent(parent)
{
  ...
  Bind(wxEVT_RADIOBUTTON, &MemoryCheckDlg::OnRadioButtonClick, this, wxID_ANY);
  ...
  wxBoxSizer* sAddressBox = new wxBoxSizer(wxHORIZONTAL);
  sAddressBox->Add(m_textAddress, 0, wxALIGN_CENTER_VERTICAL | wxLEFT | wxTOP | wxBOTTOM, 5);
  sAddressBox->Add(m_pEditAddress, 1, wxALIGN_CENTER_VERTICAL | wxTOP | wxBOTTOM, 10);

  wxBoxSizer* sAddressRangeBox = new wxBoxSizer(wxHORIZONTAL);
  sAddressRangeBox->Add(m_textStartAddress, 0, wxALIGN_CENTER_VERTICAL | wxLEFT | wxTOP | wxBOTTOM,
                        5);
  sAddressRangeBox->Add(m_pEditStartAddress, 1, wxALIGN_CENTER_VERTICAL | wxTOP | wxBOTTOM, 10);
  sAddressRangeBox->Add(m_textEndAddress, 0, wxALIGN_CENTER_VERTICAL | wxLEFT | wxTOP | wxBOTTOM,
                        5);
  sAddressRangeBox->Add(m_pEditEndAddress, 1, wxALIGN_CENTER_VERTICAL | wxTOP | wxBOTTOM, 5);

  wxStaticBoxSizer* sActions = new wxStaticBoxSizer(wxVERTICAL, this, _("Action"));
  ...
  wxStaticBoxSizer* sFlags = new wxStaticBoxSizer(wxVERTICAL, this, _("Flags"));
  sFlags->Add(m_radioLog);
  sFlags->Add(m_radioBreak);
  sFlags->Add(m_radioBreakLog);

  wxBoxSizer* sOptionsBox = new wxBoxSizer(wxHORIZONTAL);
  sOptionsBox->Add(sActions, 0, wxEXPAND | wxRIGHT | wxTOP | wxBOTTOM, 5);
  sOptionsBox->Add(sFlags, 0, wxEXPAND | wxLEFT | wxTOP | wxBOTTOM, 5);

  wxBoxSizer* sControls = new wxBoxSizer(wxVERTICAL);
