	...
	, m_game_list(game_list)
{
	...
	wxBoxSizer* const nick_szr = new wxBoxSizer(wxHORIZONTAL);
	{
		...
		m_direct_traversal = new wxChoice(panel, wxID_ANY,  wxDefaultPosition, wxSize(-1, 26));
		...
		m_trav_reset_btn = new wxButton(panel, wxID_ANY, _("Reset Traversal Settings"), wxDefaultPosition, wxSize(-1, 26));
