    ...
    : InputConfigDialog(parent, config, name, port_num)
{
  ...
  ControlGroupBox* group_box_stick =
      new ControlGroupBox(Wiimote::GetTurntableGroup(port_num, TURNTABLEGP_STICK), this, this);
  ControlGroupBox* group_box_effect_dial = new ControlGroupBox(
      Wiimote::GetTurntableGroup(port_num, TURNTABLEGP_EFFECT_DIAL), this, this);

  wxBoxSizer* stick_effect_sizer = new wxBoxSizer(wxVERTICAL);
  ...
  ControlGroupBox* group_box_left_table =
      new ControlGroupBox(Wiimote::GetTurntableGroup(port_num, TURNTABLEGP_LEFT_TABLE), this, this);
  ControlGroupBox* group_box_right_table = new ControlGroupBox(
      Wiimote::GetTurntableGroup(port_num, TURNTABLEGP_RIGHT_TABLE), this, this);
  ControlGroupBox* group_box_crossfade =
      new ControlGroupBox(Wiimote::GetTurntableGroup(port_num, TURNTABLEGP_CROSSFADE), this, this);

  wxBoxSizer* tables_crossfade_sizer = new wxBoxSizer(wxVERTICAL);
  ...
  ControlGroupBox* group_box_buttons =
      new ControlGroupBox(Wiimote::GetTurntableGroup(port_num, TURNTABLEGP_BUTTONS), this, this);
