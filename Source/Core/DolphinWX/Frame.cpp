...
void CFrame::ParseHotkeys()
{
  ...
  if (SConfig::GetInstance().m_bt_passthrough_mode == SConfig::BLUETOOTH_PASSTHROUGH_ENABLED &&
      IsHotkey(HK_TRIGGER_SYNC_BUTTON))
  {
    CWII_IPC_HLE_Device_usb_oh1_57e_305_real::TriggerSyncButtonEvent();
  }
