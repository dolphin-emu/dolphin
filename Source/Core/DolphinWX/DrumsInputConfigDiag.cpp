    ...
    : InputConfigDialog(parent, config, name, port_num)
{
  ...
  ControlGroupBox* group_box_buttons =
      new ControlGroupBox(Wiimote::GetDrumsGroup(port_num, DRUMSGP_BUTTONS), this, this);
  ControlGroupBox* group_box_pads =
      new ControlGroupBox(Wiimote::GetDrumsGroup(port_num, DRUMSGP_PADS), this, this);

  wxBoxSizer* buttons_pads_sizer = new wxBoxSizer(wxVERTICAL);
  ...
  ControlGroupBox* group_box_stick =
      new ControlGroupBox(Wiimote::GetDrumsGroup(port_num, DRUMSGP_STICK), this, this);
