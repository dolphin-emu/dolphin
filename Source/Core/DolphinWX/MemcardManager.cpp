...
{
  Config::Section* memcard_section =
      Config::GetOrCreateSection(Config::System::Main, "MemcardManager");
...
void CMemcardManager::SaveSettings()
{
  ...
  Config::Section* memcard_section =
      base_layer->GetOrCreateSection(Config::System::Main, "MemcardManager");
