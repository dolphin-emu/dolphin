...
wxString efb_copy_virtual_desc = wxTRANSLATE("Greatly increases quality of textures generated using render-to-texture effects.\nRaising the internal resolution will improve the effect of this setting.\n\nIf unsure, leave this checked.");
	...
	, ininame(_ininame)
{
	...
	efbcopy_virtual = CreateCheckBox(page_hacks, _("Virtual"), wxGetTranslation(efb_copy_virtual_desc), vconfig.bEFBCopyVirtualEnable, false);
	efbcopy_ram = CreateCheckBox(page_hacks, _("RAM"), wxGetTranslation(efb_copy_ram_desc), vconfig.bEFBCopyRAMEnable, false);
