...
{
  SetSaveSlot(event.GetId() - IDM_SELECT_SLOT_1 + 1);
  Core::DisplayMessage(StringFromFormat("Selected slot %d - %s", GetSaveSlot(),
                                        State::GetInfoStringOfSlot(GetSaveSlot()).c_str()),
                       2500);
}
