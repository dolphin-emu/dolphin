...
static wxString smart_ar_desc = wxTRANSLATE("Enable intelligent derrivation of the automatic aspect ratio.\nThis setting tries to get the aspect ratio directly from projection matricies.\nMay not work as intended in all games.\n\nIf unsure, leave this unchecked.");
	...
	, ininame(_ininame)
{
	...
	szr_misc->Add(CreateCheckBox(page_advanced, _("Enable Smart Aspect Ratio"), wxGetTranslation(smart_ar_desc), vconfig.bSmartAR));
