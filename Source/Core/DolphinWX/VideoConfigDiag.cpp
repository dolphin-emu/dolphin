...
static wxString efb_copy_clear_desc = wxTRANSLATE("Disables the black box that appears where an EFB copy should have been rendered.  Useful if you are seeing a black box after disabling EFB copies.\nIf unsure, leave this unchecked.");
