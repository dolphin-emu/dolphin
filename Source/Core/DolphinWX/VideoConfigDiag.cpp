...
static wxString efb_copy_clear_desc = wxTRANSLATE("Disables the black box that appears where an EFB copy should have been rendered.  Use only if you are seeing a black box after disabling EFB copies, or a game is not rendering properly.  May cause artifacts such as bad blending on shadows, or phantom images.\nNote: Only works in Direct3D currently.\nIf unsure, leave this unchecked.");
