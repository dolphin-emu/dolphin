...
static wxString cache_custom_textures_desc =
  ...
  // -- ADVANCED --
  {
    ...
    // - utility
    {
      ...
      szr_utility->Add(CreateCheckBox(page_advanced, _("Load Custom Textures"),
                                      ...
                                      vconfig.bCustomTextures));
      cache_custom_textures =
          CreateCheckBox(page_advanced, _("Prefetch Custom Textures"),
                         wxGetTranslation(cache_custom_textures_desc), vconfig.bCacheCustomTextures);
      szr_utility->Add(cache_custom_textures);
...
void VideoConfigDiag::OnUpdateUI(wxUpdateUIEvent& ev)
{
  ...
  // custom textures
  cache_custom_textures->Enable(vconfig.bCustomTextures);
