...
static const char* const tracker_paths[] = {"/me/head", "/me/hands/left", "/me/hands/right"};

static const char* const button_paths[OSVR_NUM_BUTTONS] = {"/controller/left/1",
                                                           "/controller/left/2",
                                                           "/controller/left/3",
                                                           "/controller/left/4",
...
static const char* const axis_paths[OSVR_NUM_AXES] = {
    "/controller/left/joystick/x", "/controller/left/joystick/y", "/controller/right/joystick/x",
    "/controller/right/joystick/y"};

static const char* const trigger_paths[OSVR_NUM_TRIGGERS] = {"/controller/left/trigger",
...
static const char* const named_buttons[OSVR_NUM_BUTTONS] = {
    "Left 1",  "Left 2",  "Left 3",  "Left 4",  "Left Bumper",  "Left Joystick",  "Left Middle",
    "Right 1", "Right 2", "Right 3", "Right 4", "Right Bumper", "Right Joystick", "Right Middle"};

static const char* const named_axes[OSVR_NUM_AXES] = {
    "Left X", "Left Y", "Right X", "Right Y",
};

static const char* const named_triggers[OSVR_NUM_TRIGGERS] = {"Left Trigger", "Right Trigger"};
...
void Tracker::TrackerCallback(void* userdata, const OSVR_TimeValue* timestamp,
...
void Controller::ButtonCallback(void* userdata, const struct OSVR_TimeValue* timestamp,
                                const struct OSVR_ButtonReport* report)
{
  *((OSVR_ButtonState*)userdata) = report->state;
}

void Controller::AnalogCallback(void* userdata, const struct OSVR_TimeValue* timestamp,
