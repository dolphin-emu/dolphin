    ...
    public:
                  ...
                  m_device_id(device_id)
        {
            ...
            jstring j_descriptor =
                    reinterpret_cast<jstring>(env->CallObjectMethod(input_device, s_input_device_get_descriptor));
...
return ToJString(env, static_cast<ciface::Android::AndroidDevice*>(device.get())->GetDescriptor());
}
