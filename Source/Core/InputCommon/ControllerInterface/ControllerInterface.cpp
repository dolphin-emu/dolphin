...
#ifdef CIFACE_USE_DINPUT
  ciface::DInput::GetDevices(reinterpret_cast<HWND>(m_hwnd));
#endif
#ifdef CIFACE_USE_XINPUT
  ciface::XInput::GetDevices();
#endif
#ifdef CIFACE_USE_XLIB
  ciface::XInput2::GetDevices(m_hwnd);
#endif
#ifdef CIFACE_USE_OSX
  ciface::OSX::GetDevices(m_hwnd);
  ciface::Quartz::GetDevices(m_hwnd);
#endif
#ifdef CIFACE_USE_SDL
  ciface::SDL::GetDevices();
#endif
#ifdef CIFACE_USE_ANDROID
  ciface::Android::GetDevices();
#endif
#ifdef CIFACE_USE_EVDEV
  ciface::evdev::GetDevices();
#endif
#ifdef CIFACE_USE_PIPES
  ciface::Pipes::GetDevices();
#endif
}
