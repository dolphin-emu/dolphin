...
std::string BuildExpression(const std::vector<Core::DeviceContainer::InputDetection>&,
                            const Core::DeviceQualifier& default_device, Quote quote);

void RemoveSpuriousTriggerCombinations(std::vector<Core::DeviceContainer::InputDetection>*);
