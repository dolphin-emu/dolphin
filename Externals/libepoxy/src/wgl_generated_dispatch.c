...
static const char *enum_strings[] = {
    [WGL_10] = "WGL 10",
    [WGL_extension_WGL_3DL_stereo_control] = "WGL extension \"WGL_3DL_stereo_control\"",
    [WGL_extension_WGL_AMD_gpu_association] = "WGL extension \"WGL_AMD_gpu_association\"",
    [WGL_extension_WGL_ARB_buffer_region] = "WGL extension \"WGL_ARB_buffer_region\"",
    [WGL_extension_WGL_ARB_create_context] = "WGL extension \"WGL_ARB_create_context\"",
    [WGL_extension_WGL_ARB_extensions_string] = "WGL extension \"WGL_ARB_extensions_string\"",
    [WGL_extension_WGL_ARB_make_current_read] = "WGL extension \"WGL_ARB_make_current_read\"",
    [WGL_extension_WGL_ARB_pbuffer] = "WGL extension \"WGL_ARB_pbuffer\"",
    [WGL_extension_WGL_ARB_pixel_format] = "WGL extension \"WGL_ARB_pixel_format\"",
    [WGL_extension_WGL_ARB_render_texture] = "WGL extension \"WGL_ARB_render_texture\"",
    [WGL_extension_WGL_EXT_display_color_table] = "WGL extension \"WGL_EXT_display_color_table\"",
    [WGL_extension_WGL_EXT_extensions_string] = "WGL extension \"WGL_EXT_extensions_string\"",
    [WGL_extension_WGL_EXT_make_current_read] = "WGL extension \"WGL_EXT_make_current_read\"",
    [WGL_extension_WGL_EXT_pbuffer] = "WGL extension \"WGL_EXT_pbuffer\"",
    [WGL_extension_WGL_EXT_pixel_format] = "WGL extension \"WGL_EXT_pixel_format\"",
    [WGL_extension_WGL_EXT_swap_control] = "WGL extension \"WGL_EXT_swap_control\"",
    [WGL_extension_WGL_I3D_digital_video_control] = "WGL extension \"WGL_I3D_digital_video_control\"",
    [WGL_extension_WGL_I3D_gamma] = "WGL extension \"WGL_I3D_gamma\"",
    [WGL_extension_WGL_I3D_genlock] = "WGL extension \"WGL_I3D_genlock\"",
    [WGL_extension_WGL_I3D_image_buffer] = "WGL extension \"WGL_I3D_image_buffer\"",
    [WGL_extension_WGL_I3D_swap_frame_lock] = "WGL extension \"WGL_I3D_swap_frame_lock\"",
    [WGL_extension_WGL_I3D_swap_frame_usage] = "WGL extension \"WGL_I3D_swap_frame_usage\"",
    [WGL_extension_WGL_NV_DX_interop] = "WGL extension \"WGL_NV_DX_interop\"",
    [WGL_extension_WGL_NV_copy_image] = "WGL extension \"WGL_NV_copy_image\"",
    [WGL_extension_WGL_NV_delay_before_swap] = "WGL extension \"WGL_NV_delay_before_swap\"",
    [WGL_extension_WGL_NV_gpu_affinity] = "WGL extension \"WGL_NV_gpu_affinity\"",
    [WGL_extension_WGL_NV_present_video] = "WGL extension \"WGL_NV_present_video\"",
    [WGL_extension_WGL_NV_swap_group] = "WGL extension \"WGL_NV_swap_group\"",
    [WGL_extension_WGL_NV_vertex_array_range] = "WGL extension \"WGL_NV_vertex_array_range\"",
    [WGL_extension_WGL_NV_video_capture] = "WGL extension \"WGL_NV_video_capture\"",
    [WGL_extension_WGL_NV_video_output] = "WGL extension \"WGL_NV_video_output\"",
    [WGL_extension_WGL_OML_sync_control] = "WGL extension \"WGL_OML_sync_control\"",
};
