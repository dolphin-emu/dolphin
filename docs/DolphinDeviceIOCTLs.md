...
|---|---|---|---|---|
| 0x01 | GetElapsedTime | none | 4 bytes (u32) | Returns the elapsed time since the emulation start in milliseconds. |
| 0x02 | GetVersion | none | null-terminated string | Returns the current Dolphin version running, based on the SCM version string. |
