...
{
public:
  void ThisMethodIsIndentedByOneLevel(int using_two_spaces)
  {
    // this method, along with its opening and closing braces are
    // indented with two spaces. This comment however is indented
    // with four spaces.
    m_other->DoStuff(m_first_parameter,
                     m_second_parameter,
                     m_third_parameter);
    // Indent for the three previous lines is done using four tabs
    ...
    // to line up the method parameters correctly.
  }
}
```
